...
dUpdateVolFM2:
	...
	dCALC_BANK	VoiceTL			; go to the Total Level offset of the voice
	dCALC_VOICE				; get address of the specific voice to a1
		...
		move.w	a6,-(sp)		; save the TL data to stack
...
.ignore
		...
		move.w	(sp)+,a6		; load TL data back from stack
...
dAMPSdoFMSFX:
		...
		lea	mTL+tSFXFM3-toSize4,a6	; load SFX FM3 TL modulation data to a6

;		cmp.w	#mSFXFM3-cSizeSFX,a5
;		beq.s	dAMPSnextFMSFX
;		bra.w	*

dAMPSnextFMSFX:
		add.w	#toSize4,a6		; go to the TL data
...
dAMPSdoFM:
		...
		lea	mTL-toSize4,a6		; load FM1 TL modulation data to a6
