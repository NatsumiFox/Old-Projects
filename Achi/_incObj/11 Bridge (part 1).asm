...
Bri_Main:	; Routine 0
	...
	display		3, a0
		...
		move.w	obY(a0),d2
		move.w	obX(a0),d3
		move.l	(a0),d4	; copy object number ($11) to d4
		lea	obSubtype(a0),a3
		moveq	#0,d1
		move.b	(a3),d1		; copy bridge length to d1
		move.b	#0,(a3)+	; clear bridge length
		move.w	d1,d0
		lsr.w	#1,d0
		lsl.w	#4,d0
		sub.w	d0,d3		; d3 is position of leftmost log
		subq.b	#2,d1
		bcs.w	Bri_Action	; don't make more if bridge has only 1 log
...
@buildloop:
	...
	@notleftmost:
		...
		move.l	d4,(a1)	; load bridge object (d4 = $11)
		move.w	d2,obY(a1)
		move.w	d2,$3C(a1)
		move.w	d3,obX(a1)
