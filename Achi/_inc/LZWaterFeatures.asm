...
DynWater_LZ3:
		...
		move.b	#1,(v_wtr_routine).w ; use second routine next
		sfx	sfx_Rumble,0,1,0 ; play sound $B7 (rumbling)
...
@chksonic:
	...
	; BORK	sfx	sfx_Waterfall,0,0,0	; play rushing water sound (only every $40 frames)
...
loc_3F9A:
		...
		andi.b	#$1F,d0
	;	bne.s	locret_3FBE
	; BORK	sfx	sfx_Waterfall,0,0,0	; play rushing water sound (only every $20 frames)
