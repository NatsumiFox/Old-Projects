...
M_ESon_Leap2:	dc.w 7
		...
		dc.b $BA, 5, 0,	$5E, $00, $10
		dc.b $CA, 2, 0,	$62, $00, $10
		dc.b $DA, $C, 0, $65, $FF, $F0
		dc.b $E2, 8, 0,	$69, $FF, $F8
		dc.b $EA, 5, 0,	$6C, $FF, $F8
M_ESon_Leap3:	dc.w $18
		dc.b $80, $F, 0, $70, $FF, $F8 ; leaping #3
		dc.b $90, $B, 0, $80, $FF, $E0
		dc.b $90, $B, 0, $8C, $00, $18
		dc.b $98, $B, 0, $98, $00, $30
		dc.b $A0, $F, 0, $A4, $00, $58
		dc.b $88, 0, 0,	$B4, $FF, $F0
		dc.b $80, 5, 0,	$B5, $00, $18
		dc.b $A0, $F, 0, $B9, $FF, $F8
		dc.b $B0, $B, 0, $C9, $FF, $E0
		dc.b $B8, $F, 0, $D5, $00, $38
		dc.b $A8, 5, 0,	$E5, $00, $48
		dc.b $C0, 2, 0,	$E9, $00, $58
		dc.b $C0, $F, 0, $EC, $FF, $F8
		dc.b $B8, $F, 0, $FC, $00, $18
		dc.b $B0, 8, 1,	$C, $00, $18
		dc.b $D8, $D, 1, $F, $00, $30
		dc.b $D8, 8, 1,	$17, $00, $18
		dc.b $D8, $F, 1, $1A, $FF, $D8
		dc.b $E0, $D, 1, $2A, $FF, $F8
		dc.b $E0, 0, 1,	$32, $00, $28
