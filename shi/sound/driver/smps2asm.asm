...
; PSG volume envelope equates
	...
	; World of Illusion
	enum sTone_27+1, sTone_28,sTone_29,sTone_2A
; ---------------------------------------------------------------------------------------------
; DAC Equates
	enum $81, dSnareS3,dKickS3,dCrashCymbal
; ---------------------------------------------------------------------------------------------
; Header Macros
...
smpsHeaderVoiceNull macro
	if songStart<>offset(*)
		inform 2,"Missing smpsHeaderStartSong"
	endif
	dc.w	$0000
    endm
...
smpsHeaderVoiceUVB macro
	...
	if smpsIsZ80=1
		littleEndian_ smpsUniVoiceBank
	else
