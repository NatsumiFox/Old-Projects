...
Title_Local:	dc.b 'ORBINAUT IN SONIC THE HEDGEHOG                  ' ; Domestic name
Title_Int:	dc.b 'ORBINAUT IN SONIC THE HEDGEHOG                  ' ; International name
...
PlaySFX:
	stopZ80
		cmp.b	Z80_RAM+$1C0B,d0
		beq.s	.skip
		tst.b	Z80_RAM+$1C0B
		bne.s	.3rdflag
		move.b	d0,Z80_RAM+$1C0B	; set sfx 1
	startZ80
		rts

.3rdflag	move.b	d0,Z80_RAM+$1C0C	; set sfx 2
.skip	startZ80
		rts
; End of function PlaySFX
...
PortA_Ok:
		bne.s	PortC_Ok
		lea	SetupValues(pc),a5	; get hardware setup values to a5
		movem.w	(a5)+,d5-d7		; move first 3 words to d5-d7
		movem.l	(a5)+,a0-a4		; move next 5 longwords to a0-a4
		move.b	-$10FF(a1),d0		; get hardware version
		andi.b	#$F,d0
		beq.s	SkipSecurity
		move.l	#'SEGA',$2F00(a1)	; validate this as a valid ROM
...
SkipSecurity:
		...
		moveq	#$17,d1		; set loop lenght

VDPInitLoop:
		move.b	(a5)+,d5	; add $8000 to value
		move.w	d5,(a4)		; move value to	VDP register
		add.w	d7,d5		; next register
		dbf	d1,VDPInitLoop	; loop until done
...
WaitForZ80:
		btst	d0,(a1)		; has Z80 stopped?
		bne.s	WaitForZ80	; if not, branch
		moveq	#$25,d2

Z80InitLoop:
		move.b	(a5)+,(a0)+	; move next instruction to Z80 RAM
		dbf	d2,Z80InitLoop	; loop until all is done
...
ClrRAMLoop:
		move.l	d0,-(a6)	; clear next longword
		dbf	d6,ClrRAMLoop	; loop until entire RAM is cleared
...
PSGInitLoop:
		...
		move	#$2700,sr	; set the sr to ignore interrupts

PortC_Ok:
		bra.s	GameProgram
; ===========================================================================
SetupValues:	dc.w $8000		; pointer for VDP register 0
		dc.w $3FFF		; RAM lenght divided by 4 (Used as lenght for RAM clearing loop)
		dc.w $100		; pointer to next VDP register
		...
		dc.b 7,	$6C, 0,	0	; increments 1 register per byte
		dc.b 0,	0, $FF,	0
		dc.b $81, $37, 0, 1
		dc.b 1,	0, 0, $FF
		dc.b $FF, 0, 0,	$80
...
GameInit:
		move.b	($A10001).l,d0
		andi.b	#$C0,d0
		move.b	d0,VersionReg.w
		lea	ChunkMappings.l,a6
		moveq	#0,d7
		move.w	#$3F7F,d6
...
GameClrRAM:
		...
		bsr.w	JoypadInit
		sf	GameMode.w ; set Game Mode to Sega Screen

MainGameLoop:
		move.b	GameMode.w,d0 ; load	Game Mode
		andi.w	#$1C,d0
...
AddressError:
		move.b	#4,ErrorMessage.w
		bra.s	loc_43A
; ===========================================================================

IllegalInstr:
		move.b	#6,ErrorMessage.w
		addq.l	#2,2(sp)
		bra.s	loc_462
; ===========================================================================

ZeroDivide:
		move.b	#8,ErrorMessage.w
		bra.s	loc_462
; ===========================================================================

ChkInstr:
		move.b	#$A,ErrorMessage.w
		bra.s	loc_462
; ===========================================================================

TrapvInstr:
		move.b	#$C,ErrorMessage.w
		bra.s	loc_462
; ===========================================================================

PrivilegeViol:
		move.b	#$E,ErrorMessage.w
		bra.s	loc_462
; ===========================================================================

Trace:
		move.b	#$10,ErrorMessage.w
		bra.s	loc_462
; ===========================================================================

Line1010Emu:
		move.b	#$12,ErrorMessage.w
		addq.l	#2,2(sp)
		bra.s	loc_462
; ===========================================================================

Line1111Emu:
		move.b	#$14,ErrorMessage.w
		addq.l	#2,2(sp)
		bra.s	loc_462
; ===========================================================================

ErrorExcept:
		move.b	#0,ErrorMessage.w
		bra.s	loc_462
; ===========================================================================
...
loc_43A:
		...
		addq.w	#2,sp
		movem.l	d0-a7,DestStateTable.w
		bsr.w	ShowErrorMsg
		move.l	2(sp),d0
		bsr.w	sub_5BA
...
loc_478:
		bsr.w	ErrorWaitForC
		movem.l	DestStateTable.w,d0-a7
		move	#$2300,sr
...
Error_LoadGfx:
		...
		moveq	#0,d0		; clear	d0
		move.b	ErrorMessage.w,d0 ; load	error code
...
; ===========================================================================
ErrorText:	dc.w asc_4E8-ErrorText,	asc_4E8-ErrorText ; XREF: ShowErrorMsg
...
asc_580:	dc.b 'TRACE              '
asc_593:	dc.b 'LINE A EMULATOR    '
asc_5A6:	dc.b 'LINE F EMULATOR    '
		even
...
ErrorWaitForC:				; XREF: loc_478
		bsr.w	ReadJoypads
		cmpi.b	#$20,Player1BtnPress.w ; is	button C pressed?
...
VInt:				; XREF: Vectors
		...
		move.w	(a6),d0
		move.l	#$40000010,(a6)
		move.l	PlaneAXPrev.w,(a5)

loc_B42:
		move.b	VBIRoutine.w,d0
		sf	VBIRoutine.w
		st	($FFFFF644).w
		andi.w	#$3E,d0
...
loc_B9A:
		cmpi.b	#1,ZoneID.w ; is level LZ ?
		bne.s	loc_B5E		; if not, branch
		move.w	(a6),d0
loc_BBA:
		move.w	VDPModeASetting.w,(a6)
		st	($FFFFF644).w
		tst.b	WatDir.w
		bne.s	loc_BFE
	dmaVDP $FFFFFB00,0,$80,CRAM	; normal pal
		bra.s	loc_C22
; ===========================================================================

loc_BFE:
	dmaVDP $FFFFFA80,0,$80,CRAM	; underwater pal
...
loc_CD4:
		move.w	VDPModeASetting.w,(a6)
	dmaVDP $FFFFF800,$F800,$280,VRAM	; sprite table
	dmaVDP $FFFFCC00,$FC00,$380,VRAM	; horiz buffer

loc_D50:
		movem.l	PlaneAX.w,d0-d7
...
Demo_Time:				; XREF: loc_D50; HInt
		...
		jsr	HudUpdate
		bsr.w	sub_165E
		tst.w	UnivCounter.w	; is there time	left on	the demo?
		beq.w	Demo_TimeEnd	; if not, branch
		subq.w	#1,UnivCounter.w ; subtract 1 from time	left
...
HInt:
		...
		movem.l	a0-a1,-(sp)
		lea	($C00000).l,a1
		lea	TargetPal.w,a0 ; load	pallet from RAM
...
ReadJoypads:
		lea	Player1BtnHeld.w,a0 ; address where joypad	states are written
...
VDP_Loop:
		...
		move.w	d0,VDPMode2Setting.w
		move.w	#$8ADF,VDPModeASetting.w
		moveq	#0,d0
...
loc_1314:
		...
		move.w	#$8F02,(a5)
		move.l	#0,PlaneAXPrev.w
		move.l	#0,PlaneBXPrev.w
		lea	SpriteTableBuf.w,a1
		moveq	#0,d0
		move.w	#$A0,d1
...
.load		move.b	(a0)+,(a1)+
		...
		lea	Z80_RAM+$1C00,a1
	rept 16
		clr.b	(a1)+			; fill with 0
	endr

		btst	#6,VersionReg.w		; is this NTSC Genesis?
...
PauseGame:				; XREF: Level_MainLoop; et al
		tst.b	LivesCounter.w	; do you have any lives	left?
		beq.w	Unpause		; if not, branch
		tst.w	PauseState.w	; is game already paused?
		bne.s	loc_13BE	; if yes, branch
		btst	#7,Player1BtnPress.w ; is Start button pressed?
		beq.w	Pause_DoNothing	; if not, branch

loc_13BE:
		move.w	#1,PauseState.w ; freeze time
	stopZ80
		move.b	#1,Z80_RAM+$1C10	; pause music
	startZ80

loc_13CA:
		move.b	#$10,VBIRoutine.w
		bsr.w	DelayProgram
		tst.b	SlowMoCheat.w	; is slow-motion cheat on?
		beq.s	Pause_ChkStart	; if not, branch
		btst	#6,Player1BtnPress.w ; is button A pressed?
...
Pause_ChkBC:				; XREF: PauseGame
		btst	#4,Player1BtnHeld.w ; is button B pressed?
		bne.s	Pause_SlowMo	; if yes, branch
		btst	#5,Player1BtnPress.w ; is button C pressed?
		bne.s	Pause_SlowMo	; if yes, branch
...
Unpause:				; XREF: PauseGame
		clr.w	PauseState.w ; unpause the game
...
LoadCompArt:
		lea	$FF0000,a1	; get address compdec buffer
		bsr.s	CompDec		; decompress art
		lea	$FF0000,a3	; get address compdec buffer again
		lea	($C00000),a6; get VDP data port
...
loc_160E:
		...
		move.l	a3,PLCQueueEnd.w
		move.l	d0,PLCQueueEnd+4.w
		move.l	d0,PLCQueueEnd+8.w
		move.l	d0,PLCQueueEnd+$C.w
		move.l	d5,PLCQueueEnd+$10.w
		move.l	d6,PLCQueueEnd+$14.w
		move.w	d2,PLCQueueEnd+$18.w
...
loc_1676:				; XREF: sub_1642
		...
		subq.w	#4,a4
		movea.l	PLCQueueAdr.w,a0
		movea.l	PLCQueueEnd,a3
		move.l	PLCQueueEnd+4.w,d0
		move.l	PLCQueueEnd+8.w,d1
		move.l	PLCQueueEnd+$C.w,d2
		move.l	PLCQueueEnd+$10.w,d5
		move.l	PLCQueueEnd+$14.w,d6
		lea	NemDecBuf.w,a1

loc_16AA:				; XREF: sub_165E
		movea.w	#8,a5
		bsr.w	NemDec3
		subq.w	#1,PLCQueueEnd+$18.w
		beq.s	loc_16DC
		subq.w	#1,PLCQueueEnd+$1A.w
		bne.s	loc_16AA
		move.l	a0,PLCQueueAdr.w
		move.l	a3,PLCQueueEnd.w
		move.l	d0,PLCQueueEnd+4.w
		move.l	d1,PLCQueueEnd+8.w
		move.l	d2,PLCQueueEnd+$C.w
		move.l	d5,PLCQueueEnd+$10.w
		move.l	d6,PLCQueueEnd+$14.w
...
loc_16DC:				; XREF: sub_165E
		...
		moveq	#((PLCQueueEnd-8-PLCQueueAdr)/4)-1,d0
...
PalCycle_Load:				; XREF: Demo; Level_MainLoop; End_MainLoop
		moveq	#0,d2
		moveq	#0,d0
		move.b	ZoneID.w,d0 ; get level number
...
loc_196A:				; XREF: PalCycle_Title
		...
		move.w	PalCycOff.w,d0
		addq.w	#1,PalCycOff.w
		andi.w	#3,d0
		lsl.w	#3,d0
		lea	($FFFFFB50).w,a1
		move.l	(a0,d0.w),(a1)+
...
PalCycle_LZ:				; XREF: PalCycle
		subq.w	#1,PalCycWait.w
		bpl.s	loc_19D8
		move.w	#2,PalCycWait.w
		move.w	PalCycOff.w,d0
		addq.w	#1,PalCycOff.w
		andi.w	#3,d0
		lsl.w	#3,d0
		lea	(Pal_LZCyc1).l,a0
		cmpi.b	#3,ActID.w ; check if level is SBZ3
		bne.s	loc_19C0
...
loc_1B06:				; XREF: PalCycle_SBZ
		...
		move.w	#1,PalCycWait.w
		tst.b	ActID.w
		beq.s	loc_1B2E
		lea	(Pal_SBZCyc10).l,a0
		move.w	#0,PalCycWait.w
...
Pal_FadeTo:
		move.w	#$3F,Palfade1.w

Pal_FadeTo2:
		moveq	#0,d0
		lea	($FFFFFB00).w,a0
		move.b	Palfade1.w,d0
		adda.w	d0,a0
		moveq	#0,d1
		move.b	Palfade2.w,d0
...
loc_206A:				; XREF: loc_202A
		subq.b	#1,PalCycWait.w
		bpl.s	loc_20BC
		move.b	#4,PalCycWait.w
		move.w	PalCycOff.w,d0
		addi.w	#$C,d0
		cmpi.w	#$30,d0
		bcs.s	loc_2088
...
; ---------------------------------------------------------------------------
; Subroutine to	delay the program by VBIRoutine frames
; ---------------------------------------------------------------------------
...
SegaScreen:				; XREF: GameModeArray
		...
		ori.b	#$40,d0
		move.w	d0,($C00004).l
		move.w	#$104,ObjRAM.w		; set logo offset to $104 (outside of screen)
		move.w	#-4,ObjRAM+2.w		; set move speed to -4
		bsr.w	RollScreen		; set Scroll RAM accordingly
		moveq	#0,d0
		bsr.w	PalLoad2		; load Sega logo pallet

		moveq	#-1,d0			; play SEGA tune
		jsr	PlayMusic.w
Sega_WaitPallet:
		move.b	#2,VBIRoutine.w		; wait for next VBlank
		bsr.w	DelayProgram		;;

		bsr.w	RollScreen		; move the logo in
		andi.b	#$80,Player1BtnPress.w 	; is start pressed?
		beq.s	.no			; if not, branch
		subq.w	#4,ObjRAM+2.w		; make it quicker

.no		cmpi.w	#0,ObjRAM.w		; has the sequence finished?
		bgt.s	Sega_WaitPallet		; if not, loop

		move.w	#0,ObjRAM.w		; make sure we have correct positioning (middle of screen)
		bsr.w	RollScreen		; set Scroll RAM accordingly
		move.b	#2,VBIRoutine.w		; wait for VBlank so it actually draws too
		bsr.w	DelayProgram		;;

		; load parts of title screen art to VRAM to make it quicker for title
		move.l	#$40000001,d4
		...
		move.w	#90,UnivCounter.w 	; set delay time
		neg.w	ObjRAM+2.w		; negate move speed
		addq.w	#2,ObjRAM+2.w		; add 2 to it

.delay		move.b	#2,VBIRoutine.w		; wait for VBlank
		bsr.w	DelayProgram		;;

.a		move.b	#2,VBIRoutine.w		; wait for VBlank
		bsr.w	DelayProgram		;;

;		bra *
Sega_WaitEnd:
		move.b	#2,VBIRoutine.w		; wait for VBlank
		bsr.w	DelayProgram		;;
		bsr.s	RollScreen		; move the logo in

		andi.b	#$80,Player1BtnPress.w	; is start pressed?
		beq.s	.no			; if not, skip
		addq.w	#4,ObjRAM+2.w		; move quicker

.no		cmpi.w	#$100,ObjRAM.w		; is sega logo out of the screen?
		blt.s	Sega_WaitEnd		; if isnt yet, branch

		moveq	#-2,d0			; play SEGA tune
		jsr	PlayMusic.w

Sega_GotoTitle:
		move.w	#$100,ObjRAM.w		; fix the positioning
		bsr.s	RollScreen		; save to Scroll RAM
		move.w	#0,CurrentPal+$40.w	; don't display white base color when switching VDP stuff
		move.b	#2,VBIRoutine.w 	; make sure it displays correctly
		bsr.w	DelayProgram		; wait until VBlank
		move.b	#4,GameMode.w 		; go to title screen

		; do some stuff for title screen so we can skip bunch of unnecessary code
		move.l	#0,ObjRAM.w		; clear variables used in the screen
		lea	($C00004).l,a6
		move.w	#$8004,(a6)
		move.w	#$8230,(a6)
		move.w	#$8407,(a6)
		...
		move.w	#$8720,(a6)
		bsr.w	ClearScreen
		bra.w	Title_FromSega

RollScreen:
		moveq	#0,d0
		move.w	ObjRAM.w,d0		; get position
		swap	d0			; swap words
		move.w	ObjRAM.w,d0		; get position again

		move.w	ObjRAM+2.w,d1		; get speed
		add.w	d1,ObjRAM.w		; add to position
		move.w	#$DF,d1			; get lenght
		lea	ScrollRAM.w,a0		; get output


.dotiles	move.l	d0,(a0)+		; move to Scroll RAM
		neg.w	d0			; negate position
		swap	d0			; swap words
		neg.w	d0			; negate position again
		dbf	d1,.dotiles		; loop until done
		rts
...
Title_FromSega:
		...
		lea	(Art_Text).l,a0
		move.w	#((VINT-Art_Text)/32)-1,d0
		bsr.w	LoadUncArt

		move.b	#0,LPostCount.w ; clear lamppost counter
		move.w	#0,ObjPlacementFlag.w ; disable debug item placement	mode
		move.w	#0,DemoModeFlag.w ; disable debug mode
		move.w	#0,($FFFFFFEA).w
		move.w	#0,ZoneID.w ; set level to	GHZ (00)
		move.w	#0,PalCycWait.w ; disable pallet cycling
		bsr.w	LevelSizeLoad
		bsr.w	LevSz_ChkLamp
		bsr.w	DeformBgLayer
		...
		clr.b	DebugFlag.w 	; disable debug mode
		move.w	#$178,UnivCounter.w ; run title	screen for $178	frames

		move.w  #$300+$60,($FFFFD00C).w
		...
		moveq	#0,d0
		bsr.w	LoadPLC2
		clr.w	CorrBtnPressCtr.w
		clr.w	CBtnPressCtr.w
		move.w	VDPMode2Setting.w,d0
		ori.b	#$40,d0
		move.w	d0,($C00004).l
		bsr.w	Pal_FadeTo
...
loc_317C:
		...
		bhi.s	Title_ChkLevSel	; if is, branch

		move.b	Player1BtnPress.w,d0
		andi.b	#$20,d0		; is C button pressed?
		beq.s	loc_3230	; if not, branch
		addq.w	#1,CBtnPressCtr.w ; increment C button counter

loc_3230:
		tst.w	UnivCounter.w
		beq.w	Demo
		andi.b	#$80,Player1BtnPress.w ; check if Start is pressed
		beq.s	loc_317C	; if not, branch
...
LevelSelect:
		...
		tst.l	PLCQueueAdr.w
		bne.s	LevelSelect
		andi.b	#$F0,Player1BtnPress.w ; is	A, B, C, or Start pressed?
		beq.s	LevelSelect	; if not, branch
		move.w	LVLSel_SelID.w,d0
		cmpi.w	#$14,d0		; have you selected item $14 (sound test)?
		bne.s	LevSel_Level_SS	; if not, go to	Level/SS subroutine
		move.w	LVLSel_SoundID.w,d0
...
LevSel_Ending:				; XREF: LevelSelect
		move.b	#$18,GameMode.w ; set screen	mode to	$18 (Ending)
		move.w	#$600,ZoneID.w ; set level	to 0600	(Ending)
		rts
; ===========================================================================

LevSel_Credits:				; XREF: LevelSelect
		move.b	#$1C,GameMode.w ; set screen	mode to	$1C (Credits)
		moveq	#15,d0
		jsr	PlayMusic.w ; play credits music
		move.w	#0,CreditNumber.w
		rts
; ===========================================================================
...
LevSel_Level_SS:			; XREF: LevelSelect
		...
		move.b	#$10,GameMode.w ; set screen	mode to	$10 (Special Stage)
		clr.w	ZoneID.w	; clear	level
		move.b	#3,LivesCounter.w ; set lives to	3
		moveq	#0,d0
		move.w	d0,RingCounter.w ; clear rings
		move.l	d0,TimeCounter.w ; clear time
		move.l	d0,ScoreCounter.w ; clear score
		rts
; ===========================================================================

LevSel_Level:				; XREF: LevSel_Level_SS
		andi.w	#$3FFF,d0
		move.w	d0,ZoneID.w ; set level number
...
PlayLevel:				; XREF: ROM:00003246j ...
		...
		move.l	d0,TimeCounter.w ; clear time
		move.l	d0,ScoreCounter.w ; clear score
		move.b	d0,SSLast.w ; clear special stage number
		move.b	d0,($FFFFFE57).w ; clear emeralds
		move.l	d0,EmeraldsCounter.w ; clear emeralds
		move.l	d0,($FFFFFE5C).w ; clear emeralds
		move.b	d0,ContinuesCount.w ; clear continues
		rts
; ===========================================================================
; ---------------------------------------------------------------------------
...
loc_33B6:				; XREF: loc_33E4
		...
		cmpi.w	#$1C00,d0
		bcs.s	loc_33E4
		move.b	#0,GameMode.w ; set screen mode to 00 (level)
		rts
; ===========================================================================

loc_33E4:				; XREF: Demo
		andi.b	#$80,Player1BtnPress.w ; is	Start button pressed?
		bne.w	Title_ChkLevSel	; if yes, branch
		tst.w	UnivCounter.w
		bne.w	loc_33B6
		move.w	DemoNumber.w,d0 ; load	demo number
		andi.w	#7,d0
		add.w	d0,d0
		move.w	Demo_Levels(pc,d0.w),d0	; load level number for	demo
		move.w	d0,ZoneID.w
		addq.w	#1,DemoNumber.w ; add 1 to demo number
		cmpi.w	#4,DemoNumber.w ; is demo number less than 4?
		bcs.s	loc_3422	; if yes, branch
		move.w	#0,DemoNumber.w ; reset demo number to	0

loc_3422:
		move.w	#1,DemoModeFlag.w ; turn	demo mode on
		move.b	#8,GameMode.w ; set screen mode to 08 (demo)
		cmpi.w	#$600,d0	; is level number 0600 (special	stage)?
		bne.s	Demo_Level	; if not, branch
		move.b	#$10,GameMode.w ; set screen	mode to	$10 (Special Stage)
		clr.w	ZoneID.w	; clear	level number
		clr.b	SSLast.w	; clear	special	stage number
...
LevSelControls:				; XREF: LevelSelect
		move.b	Player1BtnPress.w,d1
		andi.b	#3,d1		; is up/down pressed and held?
		bne.s	LevSel_UpDown	; if yes, branch
		subq.w	#1,LVLSel_MovePtr.w ; subtract 1 from time	to next	move
		bpl.s	LevSel_SndTest	; if time remains, branch

LevSel_UpDown:
		move.w	#$B,LVLSel_MovePtr.w ; reset time delay
		move.b	Player1BtnHeld.w,d1
...
LevSel_Refresh:
		move.w	d0,LVLSel_SelID.w ; set new selection
		bsr.w	LevSelTextLoad	; refresh text
		rts
; ===========================================================================

LevSel_SndTest:				; XREF: LevSelControls
		cmpi.w	#$14,LVLSel_SelID.w ; is	item $14 selected?
...
LevSel_Refresh2:
		move.w	d0,LVLSel_SoundID.w ; set sound test number
		bsr.w	LevSelTextLoad	; refresh text
...
; Music	playlist
; ---------------------------------------------------------------------------
MusicList:	dc.b $01, $02, $03, $04, $05, $06, $07, $E4
; ===========================================================================
...
loc_37B6:
		...
		move.l	#((Nem_Hud-Nem_TitleCard)/32)-1,d0
		jsr	LoadUncArt

		cmpi.w	#$502,ZoneID.w ; is level FZ?
		beq.s	Level_ClrRam	; if not, branch
...
Level_ClrVars:
		...
		lea	PlaneAX.w,a1
		moveq	#0,d0
		move.w	#((SpriteTableBuf-PlaneAX)/4)-1,d1
...
Level_ClrVars3:
		...
		move.w	(a1,d0.w),d0
		move.w	d0,WatHeight.w ; set water heights
		move.w	d0,($FFFFF648).w
		move.w	d0,($FFFFF64A).w
		clr.b	WatRoutine.w	; clear	water routine counter
		clr.b	WatDir.w	; clear	water movement
		move.b	#1,($FFFFF64C).w ; enable water

Level_LoadPal:
		move.w	#$1E,AirRemain.w
		move	#$2300,sr
		moveq	#3,d0
		...
		cmpi.b	#3,ActID.w ; is act number 3?
...
Level_WaterPal:
		...
		tst.b	LPostCount.w
		beq.s	Level_GetBgm
		move.b	LPost_WatDir.w,WatDir.w
...
Level_GetBgm:
		...
		moveq	#0,d0
		move.b	ZoneID.w,d0
		cmpi.w	#$103,ZoneID.w ; is level SBZ3?
...
Level_PlayBgm:
		...
		jsr	PlayMusic.w	; play music
		move.b	#$34,($FFFFD080).w ; load title	card object

Level_TtlCard:
		move.b	#$C,VBIRoutine.w
		bsr.w	DelayProgram
		jsr	ObjectsLoad
		jsr	BuildSprites
		bsr.w	RunPLC_RAM
		...
		jsr	Hud_Base
		move.b	#3,UnivCounter.w

.loop		move.b	#$C,VBIRoutine.w
		bsr.w	DelayProgram
		jsr	ObjectsLoad
		jsr	BuildSprites
		bsr.w	RunPLC_RAM
		subq.b	#1,UnivCounter.w
		bpl.s	.loop
...
loc_3946:
		...
		move.b	#1,ObjRAM.w ; load Sonic object
		tst.w	DemoModeFlag.w
...
Level_ChkDebug:
	if debug=0
		btst	#6,Player1BtnHeld.w ; is A button pressed?
		beq.s	Level_ChkWater	; if not, branch
	endif
		move.b	#1,DebugFlag.w ; enable debug mode

Level_ChkWater:
		move.w	#0,SonicBtnHeld.w
		move.w	#0,Player1BtnHeld.w
		cmpi.b	#1,ZoneID.w ; is level LZ?
...
Level_LoadObj:
		...
		jsr	BuildSprites
		moveq	#0,d0
		tst.b	LPostCount.w	; are you starting from	a lamppost?
		bne.s	loc_39E8	; if yes, branch
		move.w	d0,RingCounter.w ; clear rings
		move.l	d0,TimeCounter.w ; clear time
		move.b	d0,ExtraLifeGot.w ; clear lives counter

loc_39E8:
		move.b	d0,TimeOverFlag.w
		move.b	d0,GotShield.w ; clear shield
		move.b	d0,InvinFlag.w ; clear invincibility
		move.b	d0,SpeedShoeFlag.w ; clear speed shoes
		move.b	d0,($FFFFFE2F).w
		move.w	d0,ObjPlacementFlag.w
		move.w	d0,RestartLevel.w
		move.w	d0,LevelTimer.w
		bsr.w	OscillateNumInit
		move.b	#1,ScoreCounterUpd.w ; update score	counter
		move.b	#1,RingCounterUpd.w ; update rings	counter
		move.b	#1,TimeCounterUpd.w ; update time counter
		move.w	#0,DemoBtnPressOff.w
		lea	(Demo_Index).l,a1 ; load demo data
		moveq	#0,d0
		move.b	ZoneID.w,d0
		lsl.w	#2,d0
		movea.l	(a1,d0.w),a1
		tst.w	DemoModeFlag.w	; is demo mode on?
		bpl.s	Level_Demo	; if yes, branch
		lea	(Demo_EndIndex).l,a1 ; load ending demo	data
		move.w	CreditNumber.w,d0
		subq.w	#1,d0
		lsl.w	#2,d0
		movea.l	(a1,d0.w),a1

Level_Demo:
		move.b	1(a1),DemoBtnPressDur.w ; load key press duration
		subq.b	#1,DemoBtnPressDur.w ; subtract 1 from duration
		move.w	#1800,UnivCounter.w
		tst.w	DemoModeFlag.w
		bpl.s	Level_ChkWaterPal
		move.w	#540,UnivCounter.w
		cmpi.w	#4,CreditNumber.w
		bne.s	Level_ChkWaterPal
		move.w	#510,UnivCounter.w

Level_ChkWaterPal:
		cmpi.b	#1,ZoneID.w ; is level LZ/SBZ3?
		bne.s	Level_Delay	; if not, branch
		moveq	#$B,d0		; pallet $0B (LZ underwater)
		cmpi.b	#3,ActID.w ; is level SBZ3?
...
Level_DelayLoop:
		move.b	#8,VBIRoutine.w
		bsr.w	DelayProgram
		dbf	d1,Level_DelayLoop

		move.w	#$202F,Palfade1.w
		bsr.w	Pal_FadeTo2
		tst.w	DemoModeFlag.w
...
Level_StartGame:
		bclr	#7,GameMode.w ; subtract 80 from screen mode
...
Level_MainLoop:
		...
		move.b	#8,VBIRoutine.w
		bsr.w	DelayProgram
		addq.w	#1,LevelTimer.w ; add 1 to level timer
		bsr.w	MoveSonicInDemo
		bsr.w	LZWaterEffects
		jsr	ObjectsLoad
		tst.w	ObjPlacementFlag.w
		bne.s	loc_3B10
		cmpi.b	#6,($FFFFD024).w
		bcc.s	loc_3B14
...
loc_3B14:
		...
		tst.w	RestartLevel.w	; is the level set to restart?
...
Level_ChkDemo:				; XREF: Level_MainLoop
		tst.w	RestartLevel.w	; is level set to restart?
		bne.s	Level_EndDemo	; if yes, branch
		tst.w	UnivCounter.w	; is there time	left on	the demo?
		beq.s	Level_EndDemo	; if not, branch
		cmpi.b	#8,GameMode.w
		beq.w	Level_MainLoop	; if screen mode is 08 (demo), branch
		move.b	#0,GameMode.w ; go to Sega screen
		rts
; ===========================================================================

Level_EndDemo:				; XREF: Level_ChkDemo
		cmpi.b	#8,GameMode.w ; is screen mode 08 (demo)?
		bne.s	loc_3B88	; if not, branch
		move.b	#0,GameMode.w ; go to Sega screen
		tst.w	DemoModeFlag.w	; is demo mode on?
		bpl.s	loc_3B88	; if yes, branch
		move.b	#$1C,GameMode.w ; go	to credits

loc_3B88:
		move.w	#$3C,UnivCounter.w
		move.w	#$3F,Palfade1.w
		clr.w	($FFFFF794).w
...
LZWaterEffects:				; XREF: Level
		cmpi.b	#1,ZoneID.w 	; check if level is LZ
...
LZMoveWater:
		...
		lsr.w	#1,d0
		add.w	($FFFFF648).w,d0
		move.w	d0,WatHeight.w
		move.w	WatHeight.w,d0
		sub.w	PlaneAY.w,d0
		bcc.s	loc_3C1A
		tst.w	d0
		bpl.s	loc_3C1A
		st	VDPModeASetting+1.w	; $FF
		move.b	#1,WatDir.w
		rts
...
DynWater_LZ3:				; XREF: DynWater_Index
		...
		move.b	#1,WatRoutine.w
		moveq	#$B7-$6B,d0
		jsr	PlaySFX.w ; play sound $B7 (rumbling)
...
LZWindTunnels:				; XREF: LZWaterEffects
		tst.w	ObjPlacementFlag.w	; is debug mode	being used?
...
LZWind_Loop:
		...
		bne.s	loc_3E90
		moveq	#$D0-$6B,d0
		jsr	PlaySFX.w ;	play rushing water sound

loc_3E90:
		tst.b	LZWindTunnelEnable.w
		bne.w	locret_3F0A
		cmpi.b	#4,$24(a1)
		bcc.s	loc_3F06
		move.b	#1,($FFFFF7C7).w
...
LZWind_Move:
		...
		btst	#0,SonicBtnHeld.w ; is up pressed?
		beq.s	LZWind_MoveDown	; if not, branch
		subq.w	#1,$C(a1)	; move Sonic up

LZWind_MoveDown:
		btst	#1,SonicBtnHeld.w ; is down being pressed?
...
loc_3F6A:
		tst.b	SonLockControl.w
		beq.s	locret_3F7A
		move.w	#5,$3E(a1)
		clr.b	SonLockControl.w
...
loc_3F9A:
		...
		move.b	#1,SonLockControl.w ; lock	controls (except jumping)
		move.b	($FFFFFE0F).w,d0
		andi.b	#$1F,d0
		bne.s	locret_3FBE
		moveq	#$D0-$6B,d0
		jsr	PlaySFX.w ;	play water sound
...
MoveDemo_Record:
		lea	($80000).l,a1
		move.w	DemoBtnPressOff.w,d0
		adda.w	d0,a1
		move.b	Player1BtnHeld.w,d0
		cmp.b	(a1),d0
		bne.s	loc_3FFA
		addq.b	#1,1(a1)
		cmpi.b	#$FF,1(a1)
...
loc_3FFA:				; XREF: MoveDemo_Record
		move.b	d0,2(a1)
		move.b	#0,3(a1)
		addq.w	#2,DemoBtnPressOff.w
		andi.w	#$3FF,DemoBtnPressOff.w
		rts
; ===========================================================================

MoveDemo_On:				; XREF: MoveSonicInDemo
		tst.b	Player1BtnHeld.w
		bpl.s	loc_4022
		tst.w	DemoModeFlag.w
		bmi.s	loc_4022
		move.b	#4,GameMode.w
...
loc_4056:
		...
		and.b	d1,d0
		move.b	d0,(a0)+
		subq.b	#1,DemoBtnPressDur.w
		bcc.s	locret_407E
		move.b	3(a1),DemoBtnPressDur.w
		addq.w	#2,DemoBtnPressOff.w
...
ColIndexLoad:				; XREF: Level
		...
		move.b	ZoneID.w,d0
		lsl.w	#2,d0
		move.l	ColPointers(pc,d0.w),CollAdr.w
		rts
...
SignpostArtLoad:			; XREF: Level
		...
		cmpi.b	#2,ActID.w ; is act number 02 (act 3)?
		beq.s	Signpost_Exit	; if yes, branch
		move.w	PlaneAX.w,d0
		move.w	RightBound.w,d1
		subi.w	#$100,d1
		cmp.w	d1,d0		; has Sonic reached the	edge of	the level?
		blt.s	Signpost_Exit	; if not, branch
		tst.b	TimeCounterUpd.w
		beq.s	Signpost_Exit
		cmp.w	LeftBound.w,d1
		beq.s	Signpost_Exit
		move.w	d1,LeftBound.w ; move	left boundary to current screen	position
		moveq	#$12,d0
...
SpecialStage:				; XREF: GameModeArray
		moveq	#$CA-$6B,d0
		jsr	PlaySFX.w ; play special stage entry sound
		bsr.w	Pal_MakeFlash
		move	#$2700,sr
		lea	($C00004).l,a6
		move.w	#$8B03,(a6)
		move.w	#$8004,(a6)
		move.w	#$8AAF,VDPModeASetting.w
		move.w	#$9011,(a6)
		move.w	VDPMode2Setting.w,d0
		andi.b	#$BF,d0
		move.w	d0,($C00004).l
...
SS_ClrNemRam:
		...
		clr.b	WatDir.w
		clr.w	RestartLevel.w
		moveq	#$A,d0
		bsr.w	PalLoad1	; load special stage pallet
		jsr	SS_Load
		move.l	#0,PlaneAX.w
		move.l	#0,PlaneAY.w
		move.b	#9,ObjRAM.w ; load	special	stage Sonic object
		bsr.w	PalCycle_SS
		clr.w	SSAngle.w	; set stage angle to "upright"
		move.w	#$40,SSRotSpeed.w ; set stage rotation	speed
		moveq	#8,d0
		jsr	PlayMusic.w	; play special stage BG	music
		move.w	#0,DemoBtnPressOff.w
		lea	(Demo_Index).l,a1
		moveq	#6,d0
		lsl.w	#2,d0
		movea.l	(a1,d0.w),a1
		move.b	1(a1),DemoBtnPressDur.w
		subq.b	#1,DemoBtnPressDur.w
		clr.w	RingCounter.w
		clr.b	ExtraLifeGot.w
		move.w	#0,ObjPlacementFlag.w
		move.w	#1800,UnivCounter.w
		tst.b	DebugCheat.w	; has debug cheat been entered?
...
SS_MainLoop:
		bsr.w	PauseGame
		move.b	#$A,VBIRoutine.w
		bsr.w	DelayProgram
		bsr.w	MoveSonicInDemo
		move.w	Player1BtnHeld.w,SonicBtnHeld.w
		jsr	ObjectsLoad
		jsr	BuildSprites
		jsr	SS_ShowLayout
		bsr.w	SS_BGAnimate
...
SS_ChkEnd:
		...
		move.b	#$C,GameMode.w ; set	screen mode to $0C (level)
		cmpi.w	#$503,ZoneID.w ; is level number higher than FZ?
		bcs.s	SS_End		; if not, branch
		clr.w	ZoneID.w	; set to GHZ1

SS_End:
		move.w	#60,UnivCounter.w ; set	delay time to 1	second
		move.w	#$3F,Palfade1.w
		clr.w	($FFFFF794).w

SS_EndLoop:
		move.b	#$16,VBIRoutine.w
		bsr.w	DelayProgram
		bsr.w	MoveSonicInDemo
		move.w	Player1BtnHeld.w,SonicBtnHeld.w
		jsr	ObjectsLoad
...
loc_47D4:
		...
		move.b	#1,ScoreCounterUpd.w ; update score	counter
		move.b	#1,RingBonusUpdate.w ; update ring bonus counter
		move.w	RingCounter.w,d0
		mulu.w	#10,d0		; multiply rings by 10
		move.w	d0,RingBonusFlag.w ; set rings bonus
		moveq	#19,d0
		jsr	PlayMusic.w ;	play end-of-level music
		lea	ObjRAM.w,a1
		moveq	#0,d0
		move.w	#$7FF,d1
...
SS_NormalExit:
		...
		jsr	BuildSprites
		bsr.w	RunPLC_RAM
		tst.w	RestartLevel.w
		beq.s	SS_NormalExit
		tst.l	PLCQueueAdr.w
		bne.s	SS_NormalExit
		moveq	#$CA-$6B,d0
		jsr	PlaySFX.w ; play special stage exit sound
		bsr.w	Pal_MakeFlash
		rts
; ===========================================================================

SS_ToSegaScreen:
		move.b	#0,GameMode.w ; set screen mode to 00 (Sega screen)
		rts
...
PalCycle_SS:				; XREF: loc_DA6; SpecialStage
		tst.w	PauseState.w
		bne.s	locret_49E6
		subq.w	#1,SSPalCycDelay.w
		bpl.s	locret_49E6
		lea	($C00004).l,a6
		move.w	SSPalCycCounter.w,d0
		addq.w	#1,SSPalCycCounter.w
		andi.w	#$1F,d0
		lsl.w	#2,d0
		lea	(byte_4A3C).l,a0
		adda.w	d0,a0
...
loc_4992:
		...
		move.b	(a1)+,d0
		move.w	d0,(a6)
		move.b	(a1),PlaneAXPrev.w
		move.w	#-$7C00,d0
		move.b	(a0)+,d0
		move.w	d0,(a6)
		move.l	#$40000010,($C00004).l
		move.l	PlaneAXPrev.w,($C00000).l
		moveq	#0,d0
		move.b	(a0)+,d0
		bmi.s	loc_49E8
		lea	(Pal_SSCyc1).l,a1
...
SS_BGAnimate:				; XREF: SpecialStage
		...
		bne.s	loc_4BF6
		move.w	#0,PlaneBY.w
		move.w	PlaneBY.w,PlaneAYPrev.w
...
Cont_ClrObjRam:
		...
		moveq	#14,d0
		jsr	PlayMusic.w	; play continue	music
		move.w	#659,UnivCounter.w ; set time delay to 11 seconds
		clr.l	PlaneAX.w
		move.l	#$1000000,PlaneAY.w
		move.b	#$81,ObjRAM.w ; load Sonic	object
...
Cont_GotoLevel:				; XREF: Cont_MainLoop
		...
		move.l	d0,TimeCounter.w ; clear time
		move.l	d0,ScoreCounter.w ; clear score
		move.b	d0,LPostCount.w ; clear lamppost count
		subq.b	#1,ContinuesCount.w ; subtract 1 from continues
		rts
; ===========================================================================
...
Obj80_Main:				; XREF: Obj80_Index
		...
		move.w	#$120,8(a0)
		move.w	#$C0,$A(a0)
		move.w	#0,RingCounter.w ; clear rings
...
Obj81_Animate:				; XREF: Obj81_Index
		tst.b	Player1BtnPress.w	; is any button	pressed?
...
End_ClrRam3:
		...
		move.w	VDPModeASetting.w,(a6)
		move.w	#$1E,AirRemain.w
		move.w	#$600,ZoneID.w ; set level	number to 0600 (extra flowers)
		cmpi.b	#6,($FFFFFE57).w ; do you have all 6 emeralds?
		beq.s	End_LoadData	; if yes, branch
		move.w	#$601,ZoneID.w ; set level	number to 0601 (no flowers)
...
End_LoadData:
		...
		bsr.w	LoadTilesFromStart
		move.l	#Col_GHZ,CollAdr.w ; load collision	index
		move	#$2300,sr
		...
		moveq	#16,d0
		jsr	PlayMusic.w	; play ending sequence music
		btst	#6,Player1BtnHeld.w ; is button A pressed?
...
End_LoadSonic:
		...
		move.b	#1,LockJoypad.w ; lock	controls
		move.w	#$400,SonicBtnHeld.w ; move Sonic to the	left
		...
		jsr	BuildSprites
		moveq	#0,d0
		move.w	d0,RingCounter.w
		move.l	d0,TimeCounter.w
		move.b	d0,ExtraLifeGot.w
		move.b	d0,GotShield.w
		move.b	d0,InvinFlag.w
		move.b	d0,SpeedShoeFlag.w
		move.b	d0,($FFFFFE2F).w
		move.w	d0,ObjPlacementFlag.w
		move.w	d0,RestartLevel.w
		move.w	d0,LevelTimer.w
		bsr.w	OscillateNumInit
		move.b	#1,ScoreCounterUpd.w
		move.b	#1,RingCounterUpd.w
		move.b	#0,TimeCounterUpd.w
		move.w	#1800,UnivCounter.w
		move.b	#$18,VBIRoutine.w
		bsr.w	DelayProgram
		move.w	VDPMode2Setting.w,d0
		ori.b	#$40,d0
		move.w	d0,($C00004).l
...
End_MainLoop:
		...
		bsr.w	OscillateNumDo
		bsr.w	ChangeRingFrame
		cmpi.b	#$18,GameMode.w ; is	scene number $18 (ending)?
		beq.s	loc_52DA	; if yes, branch
		move.b	#$1C,GameMode.w ; set scene to $1C (credits)
		moveq	#15,d0
		jsr	PlayMusic.w ; play credits music
		clr.w	CreditNumber.w ; set credits index number to 0
		rts
; ===========================================================================
...
End_MoveSonic:				; XREF: End_MainLoop
		...
		addq.b	#2,($FFFFF7D7).w
		move.b	#1,LockJoypad.w ; lock	player's controls
		move.w	#$800,SonicBtnHeld.w ; move Sonic to the	right
		rts
; ===========================================================================
...
End_MoveSonic2:				; XREF: End_MoveSonic
		...
		addq.b	#2,($FFFFF7D7).w
		moveq	#0,d0
		move.b	d0,LockJoypad.w
		move.w	d0,SonicBtnHeld.w ; stop	Sonic moving
		move.w	d0,($FFFFD014).w
		move.b	#$81,SonIgnorePhysics.w
		move.b	#3,($FFFFD01A).w
...
End_MoveSonic3:				; XREF: End_MoveSonic
		...
		move.b	#$87,ObjRAM.w ; load Sonic	ending sequence	object
		clr.w	($FFFFD024).w
...
Obj87_LookUp:				; XREF: Obj87_Index
		...
		bne.s	locret_5480
		move.w	#1,RestartLevel.w ; set level to	restart	(causes	flash)
		move.w	#$5A,$30(a0)
		addq.b	#2,$25(a0)
...
Obj89_GotoCredits:			; XREF: Obj89_Index
		subq.w	#1,$30(a0)	; subtract 1 from duration
		bpl.s	Obj89_Display
		move.b	#$1C,GameMode.w ; exit to credits
...
loc_5862:
		...
		move.w	#120,UnivCounter.w ; display a credit for 2 seconds
		bsr.w	Pal_FadeTo
...
Cred_WaitLoop:
		...
		bsr.w	DelayProgram
		bsr.w	RunPLC_RAM
		tst.w	UnivCounter.w	; have 2 seconds elapsed?
		bne.s	Cred_WaitLoop	; if not, branch
		tst.l	PLCQueueAdr.w	; have level gfx finished decompressing?
		bne.s	Cred_WaitLoop	; if not, branch
		cmpi.w	#9,CreditNumber.w ; have	the credits finished?
...
EndingDemoLoad:				; XREF: Credits
		...
		move.w	d0,ZoneID.w ; set level from level	array
		addq.w	#1,CreditNumber.w
		cmpi.w	#9,CreditNumber.w ; have	credits	finished?
		bcc.s	EndDemo_Exit	; if yes, branch
		move.w	#$8001,DemoModeFlag.w ; force demo mode
		move.b	#8,GameMode.w ; set game mode to 08 (demo)
		move.b	#3,LivesCounter.w ; set lives to	3
		moveq	#0,d0
		move.w	d0,RingCounter.w ; clear rings
		move.l	d0,TimeCounter.w ; clear time
		move.l	d0,ScoreCounter.w ; clear score
		move.b	d0,LPostCount.w ; clear lamppost counter
		cmpi.w	#4,CreditNumber.w ; is SLZ demo running?
...
TryAg_ClrPallet:
		...
		jsr	ObjectsLoad
		jsr	BuildSprites
		move.w	#1800,UnivCounter.w ; show screen for 30 seconds
		bsr.w	Pal_FadeTo
...
TryAg_MainLoop:
		...
		tst.w	UnivCounter.w	; has 30 seconds elapsed?
		beq.s	TryAg_Exit	; if yes, branch
		cmpi.b	#$1C,GameMode.w
...
Obj8B_Main:				; XREF: Obj8B_Index
		...
		move.w	#9,CreditNumber.w ; use "TRY AGAIN" text
		move.b	#$8C,ObjRAM_Free.w ; load emeralds object on "TRY AGAIN" screen
...
LevelSizeLoad:				; XREF: TitleScreen; Level; EndingSequence
		...
		move.l	d0,TgtLeftBound.w
		move.l	(a0)+,d0
		move.l	d0,UpperBound.w
		move.l	d0,TgtUpperBound.w
...
LevSz_ChkLamp:				; XREF: LevelSizeLoad
		tst.b	LPostCount.w	; have any lampposts been hit?
...
loc_60EE:
		cmp.w	LowerBound.w,d0
		blt.s	loc_60F8
		move.w	LowerBound.w,d0
...
loc_60F8:
		...
		move.b	ZoneID.w,d0
		lsl.b	#2,d0
		move.l	LoopTileNums(pc,d0.w),LoopNums.w
		bra.w	LevSz_Unk
; ===========================================================================
; ---------------------------------------------------------------------------
...
loc_628E:
		...
		move.w	PlaneAX.w,PlaneBXPrev.w
		move.w	PlaneAY.w,PlaneAXPrev.w
		move.w	PlaneBX.w,PlaneBYPrev.w
		move.w	PlaneBY.w,PlaneAYPrev.w
		move.w	($FFFFF718).w,Prev_F718.w
		move.w	($FFFFF71C).w,Prev_F71C.w
		moveq	#0,d0
		move.b	ZoneID.w,d0
		add.w	d0,d0
...
loc_66CC:
		cmp.w	UpperBound.w,d1
		bgt.s	loc_6724
		cmpi.w	#-$100,d1
		bgt.s	loc_66F0
		andi.w	#$7FF,d1
		andi.w	#$7FF,($FFFFD00C).w
		andi.w	#$7FF,PlaneAY.w
		andi.w	#$3FF,PlaneBY.w
		bra.s	loc_6724
; ===========================================================================

loc_66F0:
		move.w	UpperBound.w,d1
		bra.s	loc_6724
; ===========================================================================
...
loc_6700:
		cmp.w	LowerBound.w,d1
		blt.s	loc_6724
		subi.w	#$800,d1
		bcs.s	loc_6720
		andi.w	#$7FF,($FFFFD00C).w
		subi.w	#$800,PlaneAY.w
		andi.w	#$3FF,PlaneBY.w
		bra.s	loc_6724
; ===========================================================================

loc_6720:
		move.w	LowerBound.w,d1
...
.list		dc.l Nem_GHZ_1st, Nem_LZ, Nem_MZ, Nem_SLZ, Nem_SYZ, Nem_SBZ
...
MainLoadBlockLoad:			; XREF: Level; EndingSequence
		...
		addq.l	#4,a2
		movea.l	(a2)+,a0
		lea	BlockMaps.w,a1 ; RAM address for 16x16 mappings
		bsr.w	CompDec
		movea.l	(a2)+,a0
		lea	ChunkMappings.l,a1	; RAM address for 256x256 mappings
		bsr.w	CompDec
		move.w	(a2)+,d0
		move.w	(a2),d0
		andi.w	#$FF,d0
		cmpi.w	#$103,ZoneID.w ; is level SBZ3 (LZ4) ?
		bne.s	MLB_ChkSBZPal	; if not, branch
		moveq	#$C,d0		; use SB3 pallet

MLB_ChkSBZPal:
		cmpi.w	#$501,ZoneID.w ; is level SBZ2?
...
MLB_NormalPal:
		...
		movea.l	(sp)+,a2
		cmpi.w	#$502,ZoneID.w ; is level FZ?
		beq.s	locret_6D10	; if not, branch
...
LevelLayoutLoad:			; XREF: TitleScreen; MainLoadBlockLoad
		lea	LevelLayout.w,a3 ; RAM address for level layout
		moveq	#0,d1
...
DynScrResizeLoad:			; XREF: DeformBgLayer
		...
		moveq	#2,d1
		move.w	TgtLowerBound.w,d0
		sub.w	LowerBound.w,d0
		beq.s	locret_6DAA
		bcc.s	loc_6DAC
		neg.w	d1
		move.w	PlaneAY.w,d0
		cmp.w	TgtLowerBound.w,d0
		bls.s	loc_6DA0
		move.w	d0,LowerBound.w
		andi.w	#-2,LowerBound.w

loc_6DA0:
		add.w	d1,LowerBound.w
		move.b	#1,($FFFFF75C).w
...
Resize_GHZ1:
		move.w	#$400,TgtLowerBound.w ; set lower	y-boundary
		cmpi.w	#$1780,PlaneAX.w ; has the camera reached $1780 on x-axis?
...
Resize_GHZ2:
		move.w	#$300,TgtLowerBound.w
		cmpi.w	#$ED0,PlaneAX.w
		bcs.s	locret_6E3A
		move.w	#$200,TgtLowerBound.w
		cmpi.w	#$1600,PlaneAX.w
		bcs.s	locret_6E3A
		move.w	#$400,TgtLowerBound.w
		cmpi.w	#$1D60,PlaneAX.w
		bcs.s	locret_6E3A
		move.w	#$300,TgtLowerBound.w
...
Resize_GHZ3main:
		move.w	#$300,TgtLowerBound.w
		cmpi.w	#$380,PlaneAX.w
		bcs.s	locret_6E96
		move.w	#$310,TgtLowerBound.w
		cmpi.w	#$960,PlaneAX.w
		bcs.s	locret_6E96
		cmpi.w	#$280,PlaneAY.w
		bcs.s	loc_6E98
		move.w	#$400,TgtLowerBound.w
		cmpi.w	#$1380,PlaneAX.w
		bcc.s	loc_6E8E
		move.w	#$4C0,TgtLowerBound.w
		move.w	#$4C0,LowerBound.w

loc_6E8E:
		cmpi.w	#$1700,PlaneAX.w
		bcc.s	loc_6E98
...
Resize_GHZ3boss:
		cmpi.w	#$960,PlaneAX.w
		bcc.s	loc_6EB0
		subq.b	#2,ResizeRoutine.w

loc_6EB0:
		cmpi.w	#$2960,PlaneAX.w
		bcs.s	locret_6EE8
		bsr.w	SingleObjLoad
		bne.s	loc_6ED0
...
loc_6ED0:
		moveq	#9,d0
		jsr	PlayMusic.w	; play boss music
		move.b	#1,ScrnLock.w ; lock	screen
		addq.b	#2,ResizeRoutine.w
		moveq	#$11,d0
...
Resize_LZ3:
		...
		moveq	#$B7-$6B,d0
		jsr	PlaySFX.w ; play rumbling sound

loc_6F28:
		tst.b	ResizeRoutine.w
		bne.s	locret_6F64
		cmpi.w	#$1CA0,PlaneAX.w
		bcs.s	locret_6F62
		cmpi.w	#$600,PlaneAY.w
		bcc.s	locret_6F62
		bsr.w	SingleObjLoad
		bne.s	loc_6F4A
...
Resize_SBZ3:
		cmpi.w	#$D00,PlaneAX.w
		bcs.s	locret_6F8C
		cmpi.w	#$18,($FFFFD00C).w ; has Sonic reached the top of the level?
		bcc.s	locret_6F8C	; if not, branch
		clr.b	LPostCount.w
		move.w	#1,RestartLevel.w ; restart level
		move.w	#$502,ZoneID.w ; set level	number to 0502 (FZ)
		move.b	#1,SonIgnorePhysics.w ; freeze Sonic
...
loc_6FBA:
		move.w	#$1D0,TgtLowerBound.w
		cmpi.w	#$700,PlaneAX.w
		bcs.s	locret_6FE8
		move.w	#$220,TgtLowerBound.w
		cmpi.w	#$D00,PlaneAX.w
		bcs.s	locret_6FE8
		move.w	#$340,TgtLowerBound.w
		cmpi.w	#$340,PlaneAY.w
		bcs.s	locret_6FE8
		addq.b	#2,ResizeRoutine.w
...
loc_6FF8:
		move.w	#0,UpperBound.w
		cmpi.w	#$E00,PlaneAX.w
		bcc.s	locret_702C
		move.w	#$340,UpperBound.w
		move.w	#$340,TgtLowerBound.w
		cmpi.w	#$A90,PlaneAX.w
		bcc.s	locret_702C
		move.w	#$500,TgtLowerBound.w
		cmpi.w	#$370,PlaneAY.w
		bcs.s	locret_702C
		addq.b	#2,ResizeRoutine.w
...
loc_703C:
		cmpi.w	#$500,PlaneAY.w
		bcs.s	locret_704E
		move.w	#$500,UpperBound.w
		addq.b	#2,ResizeRoutine.w
...
loc_7050:
		cmpi.w	#$E70,PlaneAX.w
		bcs.s	locret_7072
		move.w	#0,UpperBound.w
		move.w	#$500,TgtLowerBound.w
		cmpi.w	#$1430,PlaneAX.w
		bcs.s	locret_7072
		move.w	#$210,TgtLowerBound.w
...
Resize_MZ3boss:
		move.w	#$720,TgtLowerBound.w
		cmpi.w	#$1560,PlaneAX.w
		bcs.s	locret_70E8
		move.w	#$210,TgtLowerBound.w
		cmpi.w	#$17F0,PlaneAX.w
		bcs.s	locret_70E8
		bsr.w	SingleObjLoad
		bne.s	loc_70D0
...
Resize_SYZ2:
		move.w	#$520,TgtLowerBound.w
		cmpi.w	#$25A0,PlaneAX.w
		bcs.s	locret_71A2
		move.w	#$420,TgtLowerBound.w
...
Resize_SYZ3boss:
		cmpi.w	#$2C00,PlaneAX.w
		bcs.s	locret_7200
		move.w	#$4CC,TgtLowerBound.w
		bsr.w	SingleObjLoad
		bne.s	loc_71EC
...
Resize_SBZ1:
		move.w	#$720,TgtLowerBound.w
		cmpi.w	#$1880,PlaneAX.w
		bcs.s	locret_7242
		move.w	#$620,TgtLowerBound.w
		cmpi.w	#$2000,PlaneAX.w
		bcs.s	locret_7242
		move.w	#$2A0,TgtLowerBound.w
...
Resize_SBZ2main:
		move.w	#$800,TgtLowerBound.w
		cmpi.w	#$1800,PlaneAX.w
		bcs.s	locret_727A
		move.w	#$510,TgtLowerBound.w
		cmpi.w	#$1E00,PlaneAX.w
		bcs.s	locret_727A
		addq.b	#2,ResizeRoutine.w
...
PlatformObject:
		...
		tst.w	$12(a1)
		bmi.w	locret_751E
		btst	#0,Player1BtnHeld.w
		bne.w	locret_751E		; branch if player is holding up
...
loc_74AE:
		...
		move.b	$3D(a1),d0
		lsl.w	#6,d0
		addi.w	#ObjRAM,d0	; Silly Sonic team
		movea.w	d0,a2		; addresses are already sign-extended :D
		bclr	#3,$22(a2)
		clr.b	$25(a2)
		cmpi.b	#4,$24(a2)
		bne.s	loc_74DC
...
ExitPlatform2:
		...
		lea	ObjRAM.w,a1
		btst	#0,Player1BtnHeld.w
		bne.s	loc_75E0		; branch if player is holding up
		move.w	8(a1),d0
		sub.w	8(a0),d0
		add.w	d1,d0
		bmi.s	loc_75E0
...
Obj15_Main:				; XREF: Obj15_Index
		...
		move.w	$C(a0),$38(a0)
		move.w	8(a0),$3A(a0)
		cmpi.b	#3,ZoneID.w ; check if level is SLZ
		bne.s	Obj15_NotSLZ
...
Obj15_NotSLZ:
		cmpi.b	#5,ZoneID.w ; check if level is SBZ
...
Obj18_Main:				; XREF: Obj18_Index
		...
		move.b	#$20,$19(a0)
		cmpi.b	#4,ZoneID.w ; check if level is SYZ
		bne.s	Obj18_NotSYZ
...
loc_84F2:
		bsr.w	DisplaySprite
		moveq	#$B9-$6B,d0
		jmp	PlaySFX.w ;	play collapsing	sound
; ===========================================================================
; ---------------------------------------------------------------------------
...
Obj24_Main:				; XREF: Obj24_Index
		...
		move.b	#0,$1A(a0)
		moveq	#$A5-$6B,d0
		jsr	PlaySFX.w ;	play explosion sound
...
Obj27_Main:				; XREF: Obj27_Index
		...
		move.b	#0,$1A(a0)
		moveq	#$C1-$6B,d0
		jsr	PlaySFX.w ;	play breaking enemy sound
...
Obj3F_Main:				; XREF: Obj3F_Index
		...
		move.b	#0,$1A(a0)
		moveq	#$C4-$6B,d0
		jmp	PlaySFX.w ;	play exploding bomb sound
; ===========================================================================
Ani_obj1E:
...
CollectRing:				; XREF: Obj25_Collect
		addq.w	#1,RingCounter.w ; add 1 to rings
		ori.b	#1,RingCounterUpd.w ; update the rings counter
		cmpi.w	#100,RingCounter.w ; do	you have < 100 rings?
		bcs.s	Obj25_PlaySnd	; if yes, branch
		bset	#1,ExtraLifeGot.w ; update lives	counter
		beq.s	loc_9CA4
		cmpi.w	#200,RingCounter.w ; do	you have < 200 rings?
		bcs.s	Obj25_PlaySnd	; if yes, branch
		bset	#2,ExtraLifeGot.w ; update lives	counter
		bne.s	Obj25_PlaySnd

loc_9CA4:
		addq.b	#1,LivesCounter.w ; add 1 to the	number of lives	you have
		addq.b	#1,LiveCounterUpd.w ; add 1 to the	lives counter
		moveq	#13,d0		; play extra life music
		jmp	PlayMusic.w

Obj25_PlaySnd:
		moveq	#$33,d0	; play ring sound
		jmp	PlaySFX.w
...
Obj37_CountRings:			; XREF: Obj37_Index
		movea.l	a0,a1
		moveq	#0,d5
		move.w	RingCounter.w,d5 ; check number	of rings you have
		moveq	#32,d0
...
Obj37_ResetCounter:			; XREF: Obj37_Loop
		move.w	#0,RingCounter.w ; reset number	of rings to zero
		move.b	#$80,RingCounterUpd.w ; update ring counter
		move.b	#0,ExtraLifeGot.w
		moveq	#$C6-$6B,d0
		jsr	PlaySFX.w ;	play ring loss sound
...
Obj4B_Main:				; XREF: Obj4B_Index
		...
		cmpi.w	#50,RingCounter.w ; do you have	at least 50 rings?
...
Obj4B_PlaySnd:
		moveq	#$C3-$6B,d0
		jsr	PlaySFX.w ;	play giant ring	sound
		bra.s	Obj4B_Animate
; ===========================================================================
...
Obj7C_Collect:				; XREF: Obj7C_ChkDel
		...
		move.b	#1,IsInBigRing.w ; stop	Sonic getting bonuses
		clr.b	InvinFlag.w	; remove invincibility
		clr.b	GotShield.w	; remove shield
...
Obj7C_End:				; XREF: Obj7C_Collect
		addq.b	#2,$24(a0)
		move.w	#0,ObjRAM.w ; remove Sonic	object
		addq.l	#4,sp
		rts
...
Obj2E_ChkShoes:
		...
		move.b	#1,SpeedShoeFlag.w ; speed up the	BG music
		move.w	#$4B0,($FFFFD034).w ; time limit for the power-up
		move.l	#$A000,SonTopSpeed.w ; change Sonic's top speed
		moveq	#8,d0
		jmp	PlayTempo	; speedup
; ===========================================================================

Obj2E_ChkShield:
		cmpi.b	#4,d0		; does monitor contain a shield?
		bne.s	Obj2E_ChkInvinc
		move.b	#1,GotShield.w ; give	Sonic a	shield
		move.b	#$38,($FFFFD180).w ; load shield object	($38)
		moveq	#$AF-$6B,d0
		jmp	PlaySFX.w	; play shield sound
; ===========================================================================

Obj2E_ChkInvinc:
		cmpi.b	#5,d0		; does monitor contain invincibility?
		bne.s	Obj2E_ChkRings
		move.b	#1,InvinFlag.w ; make	Sonic invincible
		...
		move.b	#4,($FFFFD2DC).w
		tst.b	ScrnLock.w	; is boss mode on?
...
Obj2E_ChkRings:
		...
		bne.s	Obj2E_ChkS
		addi.w	#$A,RingCounter.w ; add	10 rings to the	number of rings	you have
		ori.b	#1,RingCounterUpd.w ; update the ring counter
		cmpi.w	#100,RingCounter.w ; check if you have 100 rings
		bcs.s	Obj2E_RingSound
		bset	#1,ExtraLifeGot.w
		beq.w	ExtraLife
		cmpi.w	#200,RingCounter.w ; check if you have 200 rings
		bcs.s	Obj2E_RingSound
		bset	#2,ExtraLifeGot.w
		beq.w	ExtraLife

Obj2E_RingSound:
		moveq	#$33,d0
		jmp	PlaySFX.w	; play ring sound ; <- silly Sonic Team!
; ===========================================================================
...
Obj35_Main:				; XREF: Obj35_Index
		...
		move.b	#8,$19(a0)
		moveq	#$C8-$6B,d0
		jsr	PlaySFX.w ;	play flame sound
		tst.b	$28(a0)
		beq.s	loc_B238
		addq.b	#2,$24(a0)
		bra.w	Obj35_Move
...
loc_B872:
		...
		bpl.s	loc_B892
		moveq	#$C7-$6B,d0
		jsr	PlaySFX.w ;	play rising chain sound
...
loc_B8A8:				; XREF: Obj31_Type00
		...
		bpl.s	Obj31_Restart
		moveq	#$BD-$6B,d0
		jsr	PlaySFX.w ;	play stomping sound
...
loc_BDC8:
		...
		bne.s	loc_BDD6
		moveq	#$CD-$6B,d0
		jsr	PlaySFX.w ;	play switch sound
...
Obj32_MZBlock:				; XREF: Obj32_Pressed
		...
		move.w	#$20,d4
		move.w	#$10,d5
		lea	ObjRAM_Free.w,a1 ; begin checking object RAM
		move.w	#$5F,d6
...
loc_BF6E:				; XREF: Obj33_Index
		...
		move.w	8(a0),d4
		bsr.w	loc_C186
		cmpi.w	#$200,ZoneID.w ; is the level MZ act 1?
...
Obj33_ChkLava:
		cmpi.w	#$201,ZoneID.w ; is the level MZ act 2?
...
Obj33_ChkLava2:
		cmpi.w	#$202,ZoneID.w ; is the level MZ act 3?
...
loc_C294:
		...
		move.w	d0,-(sp)
		moveq	#$A7-$6B,d0
		jsr	PlaySFX.w ;	play pushing sound
		move.w	(sp)+,d0
		tst.b	$28(a0)
		bmi.s	locret_C2E4
		move.w	d0,-(sp)
...
Obj34_CheckSBZ3:			; XREF: Obj34_Index
		...
		moveq	#0,d0
		move.b	ZoneID.w,d0
		cmpi.w	#$103,ZoneID.w ; check if level is	SBZ 3
		bne.s	Obj34_CheckFZ
		moveq	#5,d0		; load title card number 5 (SBZ)

Obj34_CheckFZ:
		move.w	d0,d2
		cmpi.w	#$502,ZoneID.w ; check if level is	FZ
...
Obj39_ChgMode:				; XREF: Obj39_Wait
		tst.b	TimeOverFlag.w	; is time over flag set?
		bne.s	Obj39_ResetLvl	; if yes, branch
		move.b	#$14,GameMode.w ; set mode to $14 (continue screen)
		tst.b	ContinuesCount.w	; do you have any continues?
		bne.s	Obj39_Display	; if yes, branch
		move.b	#0,GameMode.w ; set mode to 0 (Sega screen)
		bra.s	Obj39_Display
; ===========================================================================
...
Obj3A_Loop:
		...
		cmpi.b	#6,d0
		bne.s	loc_C5CA
		add.b	ActID.w,d0 ; add act number to frame number
...
Obj3A_TimeBonus:			; XREF: Obj3A_Index
		bsr.w	DisplaySprite
		move.b	#1,RingBonusUpdate.w ; set time/ring bonus update flag
		moveq	#0,d0
		tst.w	TimeBonusFlag.w	; is time bonus	= zero?
		beq.s	Obj3A_RingBonus	; if yes, branch
		addi.w	#10,d0		; add 10 to score
		subi.w	#10,TimeBonusFlag.w ; subtract 10	from time bonus

Obj3A_RingBonus:
		tst.w	RingBonusFlag.w	; is ring bonus	= zero?
		beq.s	Obj3A_ChkBonus	; if yes, branch
		addi.w	#10,d0		; add 10 to score
		subi.w	#10,RingBonusFlag.w ; subtract 10	from ring bonus

Obj3A_ChkBonus:
		tst.w	d0		; is there any bonus?
		bne.s	Obj3A_AddBonus	; if yes, branch
		moveq	#$C5-$6B,d0
		jsr	PlaySFX.w ;	play "ker-ching" sound
		addq.b	#2,$24(a0)
		cmpi.w	#$501,ZoneID.w
...
Obj3A_NextLevel:			; XREF: Obj3A_Index
		...
		tst.w	d0
		bne.s	Obj3A_ChkSS
		move.b	#0,GameMode.w ; set game mode to level (00)
		bra.s	Obj3A_Display2
; ===========================================================================

Obj3A_ChkSS:				; XREF: Obj3A_NextLevel
		clr.b	LPostCount.w	; clear	lamppost counter
		tst.b	IsInBigRing.w	; has Sonic jumped into	a giant	ring?
		beq.s	loc_C6EA	; if not, branch
		move.b	#$10,GameMode.w ; set game mode to Special Stage (10)
		bra.s	Obj3A_Display2
; ===========================================================================
...
Obj3A_SBZ2:				; XREF: Obj3A_ChkPos2
		...
		bne.w	DeleteObject
		addq.b	#2,$24(a0)
		clr.b	LockJoypad.w	; unlock controls
		moveq	#7,d0
		jmp	PlayMusic.w	; play FZ music
; ===========================================================================

loc_C766:				; XREF: Obj3A_Index
		addq.w	#2,RightBound.w
		cmpi.w	#$2100,RightBound.w
		beq.w	DeleteObject
		rts
; ===========================================================================
...
Obj7E_Main:
		...
		moveq	#3,d1
		cmpi.w	#50,RingCounter.w ; do you have	50 or more rings?
...
loc_C86C:				; XREF: Obj7E_ChkPos
		...
		addq.b	#2,$24(a0)
		move.w	#180,$1E(a0)	; set time delay to 3 seconds
		move.b	#$7F,ObjRAM_Free.w ; load chaos	emerald	object
...
Obj7E_RingBonus:			; XREF: Obj7E_Index
		bsr.w	DisplaySprite
		move.b	#1,RingBonusUpdate.w ; set ring bonus update flag
		tst.w	RingBonusFlag.w	; is ring bonus	= zero?
...
Obj7E_Continue:				; XREF: Obj7E_Index
		...
		moveq	#$BF-$6B,d0
		jsr	PlaySFX.w ;	play continues music
		addq.b	#2,$24(a0)
...
Obj7F_Loop:
		...
		lea	EmeraldsCounter.w,a3 ; check which emeralds	you have
		move.b	(a3,d2.w),d3
		move.b	d3,$1A(a1)
		move.b	d3,$1C(a1)
		addq.b	#1,d2
...
Obj36_Hurt:				; XREF: Obj36_SideWays; Obj36_Upright
		tst.b	InvinFlag.w	; is Sonic invincible?
...
Obj36_Wait:
		...
		bpl.s	locret_CFE6
		moveq	#$B6-$6B,d0
		jsr	PlaySFX.w ;	play "spikes moving" sound
		bra.s	locret_CFE6
; ===========================================================================
...
Obj49_PlaySnd:				; XREF: Obj49_Index
		...
		bne.s	Obj49_ChkDel
		moveq	#$D0-$6B,d0
		jsr	PlaySFX.w ;	play waterfall sound
...
Smash_PlaySnd:
		moveq	#$CB-$6B,d0
		jmp	PlaySFX.w ;	play smashing sound
...
ObjectsLoad:				; XREF: TitleScreen; et al
		lea	ObjRAM.w,a0 	; set address for object RAM
		moveq	#0,d0
		cmpi.b	#6,($FFFFD024).w
		bcc.s	loc_D362
		moveq	#((OrbRAM-ObjRAM)/$40)-1,d7
		bsr.s	loc_D348	; process 'important' objects first

		lea	ObjRAM_Free.w,a0
		moveq	#((ObjRAM_End-ObjRAM_Free)/$40)-1,d7
		bsr.s	loc_D348	; process loaded objects next

		lea	OrbRAM.w,a0
		moveq	#((ObjRAM_Free-OrbRAM)/$40)-1,d7
		; process orb objects next
		; =)
		; do not code like this, for real. I am just extremely lazy to do it 'right'
...
BuildSprites:				; XREF: TitleScreen; et al
		lea	SpriteTableBuf.w,a2 ; set address for sprite table
		moveq	#0,d5
...
OPL_Next:				; XREF: OPL_Index
		...
		move.w	PlaneAX.w,d6
		andi.w	#$FF80,d6
		cmp.w	ObjPosPlaneAX.w,d6
		beq.w	locret_DA3A
		bge.s	loc_D9F6
		move.w	d6,ObjPosPlaneAX.w
		movea.l	($FFFFF774).w,a0
		subi.w	#$80,d6
		bcs.s	loc_D9D2
...
SingleObjLoad:
		lea	ObjRAM_Free.w,a1 ; start address for object RAM
		move.w	#$5F,d0
...
Obj41_BounceUp:				; XREF: Obj41_Up
		...
		clr.b	$25(a0)
		moveq	#$CC-$6B,d0
		jsr	PlaySFX.w ;	play spring sound
...
loc_DC36:
		...
		btst	#2,$22(a1)
		bne.s	loc_DC56
		sf	$1C(a1)		; use running animation
...
Obj14_PlaySnd:
		moveq	#$AE-$6B,d0
		jsr	PlaySFX.w ;	play lava ball sound
...
Obj47_Hit:				; XREF: Obj47_Index
		...
		move.b	#1,$1C(a0)
		moveq	#$B4-$6B,d0
		jsr	PlaySFX.w ;	play bumper sound
		lea	DestStateTable.w,a2
		moveq	#0,d0
		move.b	$23(a0),d0
		beq.s	Obj47_Score
...
Obj0D_Touch:				; XREF: Obj0D_Index
		...
		moveq	#$CF-$6B,d0
		jsr	PlaySFX.w	; play signpost	sound
		clr.b	TimeCounterUpd.w	; stop time counter
		move.w	RightBound.w,LeftBound.w ; lock screen position
		addq.b	#2,$24(a0)
...
Obj0D_SonicRun:				; XREF: Obj0D_Index
		tst.w	ObjPlacementFlag.w	; is debug mode	on?
		bne.w	locret_ECEE	; if yes, branch
		move.b	#1,LockJoypad.w ; lock	controls
		move.w	#$800,SonicBtnHeld.w ; make Sonic run to	the right
...
GotThroughAct:				; XREF: Obj3E_EndAct
		...
		clr.b	InvinFlag.w	; disable invincibility
		clr.b	TimeCounterUpd.w	; stop time counter
...
loc_ECD0:
		add.w	d0,d0
		move.w	TimeBonuses(pc,d0.w),TimeBonusFlag.w ; set time bonus
		move.w	RingCounter.w,d0 ; load	number of rings
		mulu.w	#10,d0		; multiply by 10
		move.w	d0,RingBonusFlag.w ; set ring bonus
		moveq	#19,d0
		jmp	PlayMusic.w
...
SolidObject:
		...
		lea	ObjRAM.w,a1
		btst	#0,Player1BtnHeld.w
		bne.s	loc_F9FE		; branch if player is holding up
		move.w	8(a1),d0
		sub.w	8(a0),d0
		add.w	d1,d0
		bmi.s	loc_F9FE
...
loc_FBBC:
		movem.w	d0/d3/d6/a0-a6,-(sp)
		move.l	a1,a0
		bsr.w	Sonic_HitFloor
		movem.w	(sp)+,d0/d3/d6/a0-a6
...
loc_FBEE:
		...
		bmi.s	loc_FC28
		btst	#0,Player1BtnHeld.w
		bne.s	loc_FC28		; branch if player is holding up
...
Obj51_Solid:				; XREF: Obj51_Index
		move.w	OnAirEnemyKills.w,$34(a0)
...
Obj51_Smash:				; XREF: Obj51_Solid
		move.w	$34(a0),OnAirEnemyKills.w
		bset	#2,$22(a1)
		move.b	#$E,$16(a1)
		move.b	#7,$17(a1)
		move.b	#2,$1C(a1)
		...
		move.w	8(a0),8(a1)
		move.w	$C(a0),$C(a1)
		move.w	OnAirEnemyKills.w,d2
		addq.w	#2,OnAirEnemyKills.w
		cmpi.w	#6,d2
		bcs.s	Obj51_Bonus
		moveq	#6,d2
...
Obj51_Bonus:
		...
		cmpi.w	#$20,OnAirEnemyKills.w ; have 16 blocks been smashed?
...
Obj55_PlaySnd:				; XREF: Obj55_Index2
		...
		bne.s	loc_101A0
		moveq	#$C0-$6B,d0
		jsr	PlaySFX.w ;	play flapping sound
...
Obj56_Type05:				; XREF: Obj56_TypeIndex
		tst.b	$38(a0)
		bne.s	loc_104A4
		cmpi.w	#$100,ZoneID.w ; is level LZ1 ?
		bne.s	loc_1047A	; if not, branch
		cmpi.b	#3,$3C(a0)
		bne.s	loc_1047A
		clr.b	LZWindTunnelEnable.w
		move.w	($FFFFD008).w,d0
		cmp.w	8(a0),d0
		bcc.s	loc_1047A
		move.b	#1,LZWindTunnelEnable.w
...
Obj1B_Animate:				; XREF: loc_11114
		tst.w	PauseState.w	; is the game paused?
...
Obj0B_MoveUp:				; XREF: Obj0B_Action
		...
		move.w	$C(a0),d0
		subi.w	#$18,d0
		btst	#0,Player1BtnHeld.w ; check if "up" is pressed
...
Obj0B_MoveDown:
		addi.w	#$24,d0
		btst	#1,Player1BtnHeld.w ; check if "down" is pressed
		beq.s	Obj0B_LetGo
		addq.w	#1,$C(a1)	; move Sonic down
		cmp.w	$C(a1),d0
		bcc.s	Obj0B_LetGo
...
Obj0B_Grab:				; XREF: Obj0B_Action
		...
		move.b	#1,SonIgnorePhysics.w ; lock	controls
		move.b	#1,LZWindTunnelEnable.w ; disable wind	tunnel
...
Obj0C_OpenClose:			; XREF: Obj0C_Index
		...
		bpl.s	Obj0C_Solid
		moveq	#$BB-$6B,d0
		jsr	PlaySFX.w ;	play door sound

Obj0C_Solid:
		lea	(Ani_obj0C).l,a1
		bsr.w	AnimateSprite
		clr.b	LZWindTunnelEnable.w	; enable wind tunnel
		tst.b	$1A(a0)		; is the door open?
...
Obj71_ChkDel:
		...
		cmpi.w	#$280,d0
		bhi.s	Obj71_Delete
		tst.w	ObjPlacementFlag.w	; are you using	debug mode?
...
Obj64_Wobble:				; XREF: Obj64_ChkWater
		...
		moveq	#$AD-$6B,d0
		jsr	PlaySFX.w ;	play collecting	bubble sound
		lea	ObjRAM.w,a1
		clr.w	$10(a1)
		clr.w	$12(a1)
		clr.w	$14(a1)
...
; Object 01 - Sonic
; ---------------------------------------------------------------------------
Obj01_MoveOrb:				; XREF: Obj60_Index
		movea.w	$3E(a0),a1
		cmp.b	#$c,GameMode.w
		bne.s	Obj01_Circle
...
Obj01_FireOrb:
		move.w	#-$200,$10(a0)	; move orb to the left (quickly)
		btst	#0,$22(a1)
		beq.s	Obj01_Display2
		neg.w	$10(a0)

Obj01_Display2:
		bra.w	DisplaySprite

Obj01_Circle:				; XREF: Obj60_MoveOrb
		move.b	$26(a0),d0
		jsr	CalcSine
		asr.w	#4,d1
		add.w	8(a1),d1
...
Obj01_ChkDel2:				; XREF: Obj60_Index
		bsr.w	SpeedToPos
		tst.b	1(a0)
		bpl.s	RunTimer
		bra.w	DisplaySprite
...
Obj01_Index:	dc.w Obj01_Main-Obj01_Index
		...
		dc.w Obj01_MoveOrb-Obj01_Index
		dc.w Obj01_ChkDel2-Obj01_Index
; ===========================================================================
...
Obj01_Main:				; XREF: Obj01_Index
		...
		move.w	#$780,2(a0)
		move.b	#5,1(a0)
		move.l	#0,SonTopSpeed.w ; Sonic's top speed
...
Obj01_MakeOrbs:
		move.l	(a0),(a1)	; load spiked orb object
		move.l	4(a0),4(a1)
		move.b	#$A,$24(a1)
		move.w	#$308,$18(a1)
		move.b	#3,$1A(a1)
		...
		move.w	#600,$28(a1)
		lea	$40(a1),a1
		dbf	d1,Obj01_MakeOrbs ; repeat sequence 3 more times

Obj01_Control:				; XREF: Obj01_Index
		tst.w	DebugFlag.w	; is debug cheat enabled?
		beq.s	loc_12C58	; if not, branch
		btst	#4,Player1BtnPress.w ; is button C pressed?
		beq.s	loc_12C58	; if not, branch
		move.w	#1,ObjPlacementFlag.w ; change Sonic	into a ring/item
		clr.b	LockJoypad.w
		rts
; ===========================================================================

loc_12C58:
		tst.b	LockJoypad.w	; are controls locked?
		bne.s	loc_12C64	; if yes, branch
		move.w	Player1BtnHeld.w,SonicBtnHeld.w ; enable joypad control

loc_12C64:
		btst	#0,SonIgnorePhysics.w ; are controls	locked?
...
loc_12CB6:
		...
		moveq	#0,d0
		move.w	$10(a0),d0	; get x-velocity
		move.w	sr,d1		; get SR to d1
		bpl.s	.range		; if positive, do range check
		neg.w	d0		; negate d0

.range		cmp.w	#6,d0		; check if the number is 6
		bls.s	.ok		; if is, branch
		moveq	#6,d0		; force to 6

.ok		move.w	d1,sr		; get dd1 back to sr
		bpl.s	.add		; branch if was positive value
		neg.w	d0		; negate value again
...
Obj01_ChkInvin:
		tst.b	InvinFlag.w	; does Sonic have invincibility?
		...
		cmpi.w	#$C,AirRemain.w
		bcs.s	Obj01_RmvInvin

Obj01_PlayMusic_:
		moveq	#0,d0
		move.b	ZoneID.w,d0
		cmpi.w	#$103,ZoneID.w ; check if level is	SBZ3
...
Obj01_RmvInvin:
		clr.b	InvinFlag.w ; cancel invincibility

Obj01_ChkShoes:
		tst.b	SpeedShoeFlag.w	; does Sonic have speed	shoes?
		beq.s	Obj01_ExitChk	; if not, branch
		tst.w	$34(a0)		; check	time remaining
		beq.s	Obj01_ExitChk
		subq.w	#1,$34(a0)	; subtract 1 from time
		bne.s	Obj01_ExitChk
		clr.l	SonTopSpeed.w ; restore Sonic's speed
		clr.b	SpeedShoeFlag.w ; cancel speed	shoes
		bra.s	Obj01_PlayMusic_
...
Sonic_RecordPos:			; XREF: loc_12C7E; Obj01_Hurt; Obj01_Death
		move.w	SonicPrevPosArrCounter.w,d0
		lea	SonicPrevPosArr.w,a1
		lea	(a1,d0.w),a1
		move.w	8(a0),(a1)+
		move.w	$C(a0),(a1)+
		addq.b	#4,($FFFFF7A9).w
...
; ||||||||||||||| S U B	R O U T	I N E |||||||||||||||||||||||||||||||||||||||
Sonic_Move:
		lea	$12(a0),a1	; get orbinaut's vertical momemtum to a1
		move.w	#$40,d0		; set correct decelration
		bsr.s	.move		; move orbinaut
		bmi.s	.horiz		; if negative, do not allow vertical movement

		btst	#0,SonicBtnHeld.w ; is up being pressed?
		beq.s	.a		; if not, branch
		sub.l	#$A000,$C(a0)	; move orbinaut
		move.w	#-1,$12(a0)	; fake us having momemtum

.a		btst	#1,SonicBtnHeld.w ; is down being pressed?
		beq.s	.horiz		; if not, branch
		add.l	#$A000,$C(a0)	; move orbinaut
		move.w	#1,$12(a0)	; fake us having momemtum

.horiz		lea	$10(a0),a1	; get orbinaut's horizontal momemtum to a1
		move.w	#$80,d0		; set correct decelration
		bsr.s	.move
		bpl.s	.hzmove		; if positive, do allow vertical movement

.move		tst.w	(a1)		; get speed of orbinaut
		bmi.s	.slow		; branch if negative
		sub.w	d0,(a1)		; slow it down
		bmi.s	.stop		; if negative, branch
		sf	d0		; set N bit
		rts

.slow		add.w	d0,(a1)		; slow it down
		bpl.s	.stop		; if positive, branch
		sf	d0		; set N bit
		rts

.stop		clr.w	(a1)		; clear it
		rts

.hzmove		tst.w	$3E(a0)		; check if controls are locked
		bmi.s	.ok		; if are not, branch
		subq.w	#1,$3E(a0)	; sub 1 from delay
		bra.s	Obj01_ResetScr2	; do not allow control

.ok		btst	#2,SonicBtnHeld.w ; is left being pressed?
		beq.s	loc_13278	; if not, branch
		bclr	#0,$22(a0)
		move.l	#$F000,d0
		sub.l	SonTopSpeed.w,d0
		sub.l	d0,8(a0)
		move.w	#-2,$10(a0)

loc_13278:
		btst	#3,SonicBtnHeld.w ; is right being pressed?
		beq.s	Obj01_ResetScr2	; if not, branch
		bset	#0,$22(a0)
		move.l	#$F000,d0
		sub.l	SonTopSpeed.w,d0
		add.l	d0,8(a0)
...
Obj01_ResetScr2:
		move.w	#$60,($FFFFF73E).w ; the screen is in its default position
...
Boundary_Bottom:
		...
		bcs.w	KillSonic
		clr.b	LPostCount.w	; clear	lamppost counter
		move.w	#1,RestartLevel.w ; restart the level
		move.w	#$103,ZoneID.w ; set level	to SBZ3	(LZ4)
		rts
; ===========================================================================
...
GameOver:				; XREF: Obj01_Death
		...
		addq.b	#2,$24(a0)
		clr.b	TimeCounterUpd.w	; stop time counter
		addq.b	#1,LiveCounterUpd.w ; update lives	counter
		subq.b	#1,LivesCounter.w ; subtract 1 from number of lives
		bne.s	loc_138D4
		move.w	#0,$3A(a0)
		...
		clr.b	TimeOverFlag.w

loc_138C2:
		moveq	#12,d0
		jsr	PlayMusic.w	; play game over music
		moveq	#3,d0
...
loc_138D4:
		move.w	#60,$3A(a0)	; set time delay to 1 second
		tst.b	TimeOverFlag.w	; is TIME OVER tag set?
...
Sonic_Loops:				; XREF: Obj01_Control
		cmpi.b	#3,ZoneID.w	; is level SLZ ?
		beq.s	loc_13926	; if yes, branch
		tst.b	ZoneID.w	; is level GHZ ?
...
Obj0A_AirLeft:				; XREF: Obj0A_Index
		cmpi.w	#$C,AirRemain.w ; check air remaining
...
Obj0A_Countdown:			; XREF: Obj0A_Index
		...
		andi.w	#1,d0
		move.b	d0,$34(a0)
		move.w	AirRemain.w,d0 ; check air remaining
		cmpi.w	#$19,d0
		...
		bne.s	loc_13F02
		moveq	#11,d0
		jsr	PlayMusic.w	; play countdown music
...
Obj0A_WarnSound:			; XREF: Obj0A_Countdown
		moveq	#$C2-$6B,d0
		jsr	PlaySFX.w ;	play "ding-ding" warning sound

Obj0A_ReduceAir:
		subq.w	#1,AirRemain.w ; subtract 1 from air remaining
		bcc.w	Obj0A_GoMakeItem ; if air is above 0, branch
		bsr.w	ResumeMusic
		move.b	#$81,SonIgnorePhysics.w ; lock controls
		moveq	#$B2-$6B,d0
		jsr	PlaySFX.w ;	play drowning sound
		move.b	#$A,$34(a0)
		move.w	#1,$36(a0)
		move.w	#$78,$2C(a0)
		move.l	a0,-(sp)
...
ResumeMusic:				; XREF: Obj64_Wobble; Sonic_Water; Obj0A_ReduceAir
		cmpi.w	#$C,AirRemain.w
		bhi.s	loc_140AC
		moveq	#2,d0		; play LZ music
		cmpi.w	#$103,ZoneID.w ; check if level is	0103 (SBZ3)
		bne.s	loc_140A6
		moveq	#6,d0		; play SBZ music
...
Obj38_Shield:				; XREF: Obj38_Index
		...
		tst.b	GotShield.w	; does Sonic have shield?
...
Obj4A_RmvSonic:				; XREF: Obj4A_Index
		...
		tst.b	ObjRAM.w
		beq.s	Obj4A_Display
		move.b	#0,ObjRAM.w ; remove Sonic
		moveq	#$A8-$6B,d0
		jsr	PlaySFX.w ;	play Special Stage "GOAL" sound
...
Obj08_Display:				; XREF: Obj08_Index
		move.w	WatHeight.w,$C(a0) ; copy y-position from water height
		lea	(Ani_obj08).l,a1
		jsr	AnimateSprite
		jmp	DisplaySprite
; ===========================================================================
...
loc_149EC:
		movea.l	CollAdr.w,a2 ; load	collision index
		move.b	(a2,d0.w),d0
		andi.w	#$FF,d0
		beq.s	loc_149DE
		lea	(AngleMap).l,a2
...
loc_150FE:; dat extreme lag!
		move.b	#$30,$19(a0)
		move.b	#4,$18(a0)
		move.w	#$3C,$30(a0)
		move.b	#1,$34(a0)
		move.b	$28(a0),$38(a0)
		clr.b	$21(a0)			; can grab player instantly
...
Obj66_Action:				; XREF: Obj66_Index
		...
		addq.w	#1,d3
		move.w	8(a0),d4
		bsr.w	SolidObject		; run solidity subroutines
		beq.w	Obj66_Display		; branch if no collision happens

		tst.b	$21(a0)			; check if delay is over
		bne.s	Obj66_Delay		; branch if not

		lea	ObjRAM.w,a1
		move.w	$C(a0),d0		; get y-pos of this object
		sub.w	$C(a1),d0		; sub y-pos of Sonic
		add.w	#40,d0			; sub 32 more pixels
		bmi.s	Obj66_Display		; if player is above than y-pos + 32, then do not grab Sonic
...
Obj66_GrabSonic:
		cmp.b	$1A(a0),d1
		bne.s	Obj66_Display		; check if we are in correct frame to grab sonic
		move.b	d1,$32(a0)
		addq.b	#4,$24(a0)
		move.b	#1,SonIgnorePhysics.w ; lock controls
...
Obj66_Delay:
		subq.b	#1,$21(a0)	; sub 1 from grab delay
...
loc_151F0:
		clr.b	SonIgnorePhysics.w	; unlock controls
		subq.b	#4,$24(a0)
		move.b	#15,$21(a0)		; wait 15 frames to release
...
Obj68_MoveSonic:			; XREF: Obj68_Action
		...
		move.w	$C(a1),d1		; get y-position of player
		sub.w	$C(a0),d1		; sub y-position of object
		addi.w	#24,d1			; add offset
		cmpi.w	#32,d1			; check for height
		bhs.s	locret_1572E		; branch if below or above object
		move.w	$36(a0),d0
		add.w	d0,8(a1)
...
Obj6B_Main:				; XREF: Obj6B_Index
		...
		move.w	#$22C0,2(a0)
		cmpi.b	#1,ZoneID.w ; check if level is LZ/SBZ3
...
loc_15EE0:
	; check if player is supposed to be crushed here
		bsr.w	Obj6B_Kill

.delay		subq.w	#1,$36(a0)
		bpl.s	loc_15EF0
		move.w	#$3C,$36(a0)
		clr.b	$38(a0)
...
Obj6E_Shock:				; XREF: Obj6E_Index
		...
		bpl.s	Obj6E_Animate
		moveq	#$B1-$6B,d0
		jsr	PlaySFX.w ;	play electricity sound
...
loc_1629A:
		cmpi.b	#2,ActID.w ; check if act	is 3
...
loc_1670E:
		...
		clr.b	$32(a0)
		moveq	#$BE-$6B,d0
		jsr	PlaySFX.w ;	play Sonic rolling sound
...
loc_1675E:				; XREF: Obj72_Index
		...
		addq.b	#2,$24(a0)
		moveq	#$BC-$6B,d0
		jsr	PlaySFX.w ;	play teleport sound
...
Obj78_Main:				; XREF: Obj78_Index
		...
		move.w	#$22B0,2(a0)
		cmpi.b	#5,ZoneID.w ; if level is SBZ, branch
		beq.s	loc_16996
...
Obj79_HitLamp:
		...
		bcc.s	locret_16F90
		moveq	#$A1-$6B,d0
		jsr	PlaySFX.w ;	play lamppost sound
		addq.b	#2,$24(a0)
		jsr	SingleObjLoad
		bne.s	loc_16F76
...
Obj79_StoreInfo:			; XREF: Obj79_HitLamp
		move.b	$28(a0),LPostCount.w 		; lamppost number
		move.b	LPostCount.w,LPost_LposCount.w
		move.w	8(a0),LPost_SonX.w		; x-position
		move.w	$C(a0),LPost_SonY.w		; y-position
		move.w	RingCounter.w,LPost_RingCounter.w 	; rings
		move.b	ExtraLifeGot.w,LPost_LivesCounter.w 	; lives
		move.l	TimeCounter.w,LPost_TimeCounter.w 	; time
		move.b	ResizeRoutine.w,LPost_LVLResize.w 	; routine counter for dynamic level mod
		move.w	LowerBound.w,LPost_LVLLowBound.w 	; lower y-boundary of level
		move.w	PlaneAX.w,LPost_PlaneAX.w 	; screen x-position
		move.w	PlaneAY.w,LPost_PlaneAY.w 	; screen y-position
		move.w	PlaneBX.w,($FFFFFE44).w 	; bg position
		move.w	PlaneBY.w,($FFFFFE46).w 	; bg position
		...
		move.w	($FFFFF648).w,LPost_WatHeight.w 	; water height
		move.b	WatRoutine.w,LPost_WatRoutine.w 	; rountine counter for water
		move.b	WatDir.w,LPost_WatDir.w 	; water direction
		rts
...
Obj79_LoadInfo:				; XREF: LevelSizeLoad
		move.b	LPost_LposCount.w,LPostCount.w
		move.w	LPost_SonX.w,($FFFFD008).w
		move.w	LPost_SonY.w,($FFFFD00C).w
		move.w	LPost_RingCounter.w,RingCounter.w
		move.b	LPost_LivesCounter.w,ExtraLifeGot.w
		clr.w	RingCounter.w
		clr.b	ExtraLifeGot.w
		move.l	LPost_TimeCounter.w,TimeCounter.w
		move.b	#59,($FFFFFE25).w
		subq.b	#1,($FFFFFE24).w
		move.b	LPost_LVLResize.w,ResizeRoutine.w
		move.b	LPost_WatRoutine.w,WatRoutine.w
		move.w	LPost_LVLLowBound.w,LowerBound.w
		move.w	LPost_LVLLowBound.w,TgtLowerBound.w
		move.w	LPost_PlaneAX.w,PlaneAX.w
		move.w	LPost_PlaneAY.w,PlaneAY.w
		move.w	($FFFFFE44).w,PlaneBX.w
		move.w	($FFFFFE46).w,PlaneBY.w
		...
		cmpi.b	#1,ZoneID.w
		bne.s	loc_170E4
		move.w	LPost_WatHeight.w,($FFFFF648).w
		move.b	LPost_WatRoutine.w,WatRoutine.w
		move.b	LPost_WatDir.w,WatDir.w
...
Obj7D_Main:				; XREF: Obj7D_Index
		...
		moveq	#$C9-$6B,d0
		jsr	PlaySFX.w ;	play bonus sound
		moveq	#0,d0
		move.b	$28(a0),d0
		add.w	d0,d0
...
Obj8A_Main:				; XREF: Obj8A_Index
		...
		move.w	#$5A0,2(a0)
		move.w	CreditNumber.w,d0 ; load	credits	index number
		...
		cmpi.b	#$72,Player1BtnHeld.w ; is	Start+A+C+Down being pressed?
		bne.s	Obj8A_Display	; if not, branch
...
loc_177E6:
		...
		moveq	#$AC-$6B,d0
		jsr	PlaySFX.w ;	play boss damage sound
...
loc_18BB4:
		clr.w	$12(a0)
		moveq	#4,d0
		jsr	PlayMusic.w	; play SLZ music
...
Obj82_FindBlocks:
		...
		or.w	$12(a0),d0
		bne.s	loc_199D0
		lea	ObjRAM.w,a1 ; start at the	first object RAM
		moveq	#$3E,d0
		moveq	#$40,d1
...
Obj83_BreakSnd:
		moveq	#$CB-$6B,d0
		jsr	PlaySFX.w ;	play smashing sound
		jmp	DisplaySprite
; ===========================================================================
...
loc_1A020:
		moveq	#$B1-$6B,d0
		jmp	PlaySFX.w ;	play electricity sound
; ===========================================================================
...
loc_1A216:
		...
		blt.s	loc_1A23A
		move.b	#1,LockJoypad.w
		move.w	#0,SonicBtnHeld.w
		clr.w	($FFFFD014).w
		tst.w	$12(a0)
		bpl.s	loc_1A248
		move.w	#$100,SonicBtnHeld.w
...
Obj3E_Switched:				; XREF: Obj3E_Index
		...
		move.w	#$3C,$1E(a0)
		clr.b	TimeCounterUpd.w	; stop time counter
		clr.b	ScrnLock.w	; lock screen position
		move.b	#1,LockJoypad.w ; lock	controls
		move.w	#$800,SonicBtnHeld.w ; make Sonic run to	the right
		clr.b	$25(a0)
		bclr	#3,($FFFFD022).w
...
TouchResponse:
		move.w	d7,-(sp)	; store object and objcount
		link	a6,#-5*2	; allocate size for 5 words
		lea	(a6),a5		; copy to a5

		lea	OrbRAM.w,a0	; get 4 orbs around the orbinaut
		moveq	#4-1,d7		; 4 entries
.orb		bsr.s	Touch_Once	; check collisions for this orb
		lea	$40(a0),a0	; next object RAM
		dbf	d7,.orb		; loop for all of em

		lea	ObjRAM.w,a0	; get the orbinaut itself
		bsr.s	Touch_Once	; check touch response for it too!

.rts		unlk	a6		; unallocate our data
		move.w	(sp)+,d7	; pop object and objcount
		moveq	#0,d0
		rts

Touch_Once_Ret:
		move.w	(sp)+,d7	; get back the old counter
		bra.s	Touch_NextObj	; get next object
...
Touch_Once:
		...
		move.w	#$10,d4
		add.w	d5,d5
		lea	ObjRAM_Free.w,a1 ; begin checking the object RAM
		move.w	#$5F,d6

Touch_Loop:
		tst.b	1(a1)
		bpl.s	Touch_NextObj	; branch if not displaying
...
Touch_Sizes:	dc.b  $14, $14		; width, height
		...
		dc.b   $C, $18
		dc.b  $48,   8
		; this code is so large now!
; ===========================================================================

Touch_Height:
	; check if we find the same object has been already used
		move.w	d7,-(sp)	; store current repeat count
		lea	(a6),a4		; get address
		moveq	#5-1,d7		; 5 entries

.chkloop	cmp.w	-(a4),a1	; check against next address
		beq.w	Touch_Once_Ret	; if equal, get next object
		dbf	d7,.chkloop	; loop for all 5 entries

	; all good to go, did not find this object
		move.w	(sp)+,d7	; get stack variable back
		andi.w	#$3F,d0
		add.w	d0,d0
...
Touch_ChkValue:
		...
		beq.s	Touch_Enemy	; if not, branch
...
; touch	response is $40-$7F
		...
		cmpi.w	#$5A,ObjRAM+$30.w; check if orbinatu is vulnerable
		bcc.w	locret_1AEF2	; if so, branch
		addq.b	#2,$24(a1)	; advance the object's routine counter
		move.w	a1,-(a5)	; set object as touched
...
Touch_KillEnemy:
		bset	#7,$22(a1)
		moveq	#0,d0
		move.w	OnAirEnemyKills.w,d0
		addq.w	#2,OnAirEnemyKills.w ; add 2 to item bonus counter
		cmpi.w	#6,d0
		bcs.s	loc_1AF82
		moveq	#6,d0
...
loc_1AF82:
		...
		cmpi.w	#$20,OnAirEnemyKills.w ; have 16 enemies been destroyed?
...
KillSonic:
		tst.w	ObjPlacementFlag.w	; is debug mode	active?
		bne.s	Kill_NoDeath	; if yes, branch
		move.b	#0,InvinFlag.w ; remove invincibility
		move.b	#6,$24(a0)
		bsr.w	Sonic_ResetOnFloor
		move.w	#-$700,$12(a0)
		clr.w	$10(a0)
		...
		move.b	#$18,$1C(a0)
		bset	#7,2(a0)
		moveq	#$A3-$6B,d0	; play normal death sound
		cmpi.b	#$36,(a2)	; check	if you were killed by spikes
		bne.s	Kill_Sound
		moveq	#$A6-$6B,d0	; play spikes death sound
...
Touch_Special:				; XREF: Touch_ChkValue
		move.b	$20(a1),d1
		andi.b	#$3F,d1
		cmpi.b	#$B,d1		; is touch response $CB (Caterkillar body part)?
		beq.w	Touch_ChkHurt	; if yes, branch
		cmpi.b	#$C,d1		; is touch response $CC?
		beq.w	Touch_Enemy	; if yes, branch
...
SS_Load:				; XREF: SpecialStage
		moveq	#0,d0
		move.b	SSLast.w,d0 ; load	number of last special stage entered
		addq.b	#1,SSLast.w
		cmpi.b	#6,SSLast.w
		bcs.s	SS_ChkEmldNum
		move.b	#0,SSLast.w ; reset if higher than	6
...
Obj09_Index:	dc.w Obj09_Main-Obj09_Index
		...
		dc.w Obj09_Exit2-Obj09_Index
		dc.w .move-Obj09_Index
		dc.w .cdel-Obj09_Index

.move		jmp	Obj01_MoveOrb
.cdel		jmp	Obj01_ChkDel2
; ===========================================================================
...
Obj09_MakeOrbs:
		...
		move.w	#600,$28(a1)
		lea	$40(a1),a1
		dbf	d1,Obj09_MakeOrbs ; repeat sequence 3 more times

Obj09_ChkDebug:				; XREF: Obj09_Index
		tst.w	DebugFlag.w	; is debug mode	cheat enabled?
		beq.s	Obj09_NoDebug	; if not, branch
		btst	#4,Player1BtnPress.w ; is button B pressed?
		beq.s	Obj09_NoDebug	; if not, branch
		move.w	#1,ObjPlacementFlag.w ; change Sonic	into a ring
...
Obj09_Move:				; XREF: Obj09_OnWall; Obj09_InAir
		...
		btst	#2,SonicBtnHeld.w ; is left being pressed?
		beq.s	Obj09_ChkRight	; if not, branch
		moveq	#-1,d0

Obj09_ChkRight:
		btst	#3,SonicBtnHeld.w ; is right being pressed?
		beq.s	.ud		; if not, branch
		moveq	#1,d0

.ud		btst	#0,SonicBtnHeld.w ; is left being pressed?
		beq.s	Obj09_	; if not, branch
		moveq	#-1,d0
		moveq	#-1,d6

Obj09_:		btst	#1,SonicBtnHeld.w ; is right being pressed?
...
Obj09_ExitStage:			; XREF: Obj09_Index
		addi.w	#$40,SSRotSpeed.w
		cmpi.w	#$1800,SSRotSpeed.w
		bne.s	loc_1BBF4
		move.b	#$C,GameMode.w

loc_1BBF4:
		cmpi.w	#$3000,SSRotSpeed.w
		blt.s	loc_1BC12
		move.w	#0,SSRotSpeed.w
...
Obj09_GetCont:
		jsr	CollectRing
		cmpi.w	#50,RingCounter.w ; check if you have 50 rings
		bcs.s	Obj09_NoCont
		bset	#0,ExtraLifeGot.w
		bne.s	Obj09_NoCont
		addq.b	#1,ContinuesCount.w ; add 1 to number of continues
		moveq	#14,d0
		jsr	PlayMusic.w	; play extra continue sound
...
Obj09_Get1Up:
		addq.b	#1,LivesCounter.w ; add 1 to number of lives
		addq.b	#1,LiveCounterUpd.w ; add 1 to lives counter
		moveq	#13,d0
		jsr	PlayMusic.w	; play extra life music
		moveq	#0,d4
		rts
; ===========================================================================
...
Obj09_GetEmer:
		...
		moveq	#0,d0
		move.b	($FFFFFE57).w,d0
		lea	EmeraldsCounter.w,a2
		move.b	d4,(a2,d0.w)
		addq.b	#1,($FFFFFE57).w ; add 1 to number of emeralds

Obj09_NoEmer:
		moveq	#$93-$6B,d0
		jsr	PlaySFX.w ;	play emerald music
		moveq	#0,d4
		rts
; ===========================================================================
...
Obj09_BumpSnd:
		moveq	#$B4-$6B,d0
		jmp	PlaySFX.w ;	play bumper sound
; ===========================================================================
...
Obj09_GOAL:
		...
		moveq	#$A8-$6B,d0		; change item
		jmp	PlaySFX.w ;	play "GOAL" sound
; ===========================================================================
...
Obj09_UPblock:
		...
		btst	#6,($FFFFF783).w
		beq.s	Obj09_UPsnd
		asl	SSRotSpeed.w	; increase stage rotation speed
		movea.l	$32(a0),a1
		subq.l	#1,a1
...
Obj09_UPsnd:
		moveq	#$A9-$6B,d0
		jmp	PlaySFX.w ;	play up/down sound
; ===========================================================================
...
Obj09_DOWNblock:
		...
		btst	#6,($FFFFF783).w
		bne.s	Obj09_DOWNsnd
		asr	SSRotSpeed.w	; reduce stage rotation	speed
		movea.l	$32(a0),a1
		subq.l	#1,a1
...
Obj09_RevStage:
		neg.w	SSRotSpeed.w	; reverse stage	rotation
		moveq	#$A9-$6B,d0
		jmp	PlaySFX.w ;	play sound
; ===========================================================================
...
Obj09_GlassSnd:
		moveq	#$BA-$6B,d0
		jmp	PlaySFX.w ;	play glass block sound
; ===========================================================================
...
Obj21_Flash:				; XREF: Obj21_Main
		tst.w	RingCounter.w	; do you have any rings?
...
AddPoints:
		move.b	#1,ScoreCounterUpd.w ; set score counter to	update
		lea	($FFFFFFC0).w,a2
		lea	ScoreCounter.w,a3
...
HudUpdate:
		tst.w	DebugFlag.w	; is debug mode	on?
		bne.w	HudDebug	; if yes, branch
		tst.b	ScoreCounterUpd.w	; does the score need updating?
		beq.s	Hud_ChkRings	; if not, branch
		clr.b	ScoreCounterUpd.w
		move.l	#$5C800003,d0	; set VRAM address
		move.l	ScoreCounter.w,d1 ; load	score
		bsr.w	Hud_Score

Hud_ChkRings:
		tst.b	RingCounterUpd.w	; does the ring	counter	need updating?
		beq.s	Hud_ChkTime	; if not, branch
		bpl.s	loc_1C6E4
		bsr.w	Hud_LoadZero

loc_1C6E4:
		clr.b	RingCounterUpd.w
		move.l	#$5F400003,d0	; set VRAM address
		moveq	#0,d1
		move.w	RingCounter.w,d1 ; load	number of rings
		bsr.w	Hud_Rings

Hud_ChkTime:
		tst.b	TimeCounterUpd.w	; does the time	need updating?
		beq.s	Hud_ChkLives	; if not, branch
		tst.w	PauseState.w	; is the game paused?
		bne.s	Hud_ChkLives	; if yes, branch
		lea	TimeCounter.w,a1
...
Hud_ChkLives:
		tst.b	LiveCounterUpd.w	; does the lives counter need updating?
		beq.s	Hud_ChkBonus	; if not, branch
		clr.b	LiveCounterUpd.w
		bsr.w	Hud_Lives

Hud_ChkBonus:
		tst.b	RingBonusUpdate.w	; do time/ring bonus counters need updating?
		beq.s	Hud_End		; if not, branch
		clr.b	RingBonusUpdate.w
		move.l	#$6E000002,($C00004).l
		moveq	#0,d1
		move.w	TimeBonusFlag.w,d1 ; load	time bonus
		bsr.w	Hud_TimeRingBonus
		moveq	#0,d1
		move.w	RingBonusFlag.w,d1 ; load	ring bonus
		bsr.w	Hud_TimeRingBonus
...
TimeOver:				; XREF: Hud_ChkTime
		clr.b	TimeCounterUpd.w
		lea	ObjRAM.w,a0
		movea.l	a0,a2
		bsr.w	KillSonic
		move.b	#1,TimeOverFlag.w
		rts
; ===========================================================================
...
HudDb_ObjCount:
		...
		moveq	#0,d1
		move.b	SpriteCounter.w,d1 ; load	"number	of objects" counter
		bsr.w	Hud_Secs
		tst.b	LiveCounterUpd.w	; does the lives counter need updating?
...
HudDb_ChkBonus:
		tst.b	RingBonusUpdate.w	; does the ring/time bonus counter need	updating?
...
HudDb_XY:				; XREF: HudDebug
		...
		move.w	PlaneAX.w,d1 ; load	camera x-position
		swap	d1
		move.w	($FFFFD008).w,d1 ; load	Sonic's x-position
		bsr.s	HudDb_XY2
		move.w	PlaneAY.w,d1 ; load	camera y-position
		swap	d1
...
Hud_Lives:				; XREF: Hud_ChkLives
		...
		moveq	#0,d1
		move.b	LivesCounter.w,d1 ; load	number of lives
		lea	(Hud_10).l,a2
		moveq	#1,d6
		moveq	#0,d4
...
Debug_Main:				; XREF: Debug_Index
		addq.b	#2,ObjPlacementFlag.w
		move.w	UpperBound.w,($FFFFFEF0).w ; buffer level x-boundary
		move.w	TgtLowerBound.w,($FFFFFEF2).w ; buffer level y-boundary
		move.w	#0,UpperBound.w
		move.w	#$720,TgtLowerBound.w
		andi.w	#$7FF,($FFFFD00C).w
		andi.w	#$7FF,PlaneAY.w
		...
		move.w	#0,SSRotSpeed.w ; stop	special	stage rotating
		move.w	#0,SSAngle.w ; make	special	stage "upright"
...
Debug_UseList:
		...
		adda.w	(a2,d0.w),a2
		move.w	(a2)+,d6
		cmp.b	DebugItemPtr.w,d6
		bhi.s	loc_1CF9E
		move.b	#0,DebugItemPtr.w
...
Debug_BackItem:
		...
		subq.b	#1,DebugItemPtr.w ; go back 1 item
		bcc.s	Debug_NoLoop
		add.b	d6,DebugItemPtr.w
		bra.s	Debug_NoLoop
; ===========================================================================
...
Debug_NextItem:
		btst	#6,Player1BtnPress.w ; is button A pressed?
		beq.s	Debug_MakeItem	; if not, branch
		addq.b	#1,DebugItemPtr.w ; go forwards 1 item
		cmp.b	DebugItemPtr.w,d6
		bhi.s	Debug_NoLoop
		move.b	#0,DebugItemPtr.w ; loop	back to	first item
...
Debug_Exit:
		...
		moveq	#0,d0
		move.w	d0,ObjPlacementFlag.w ; deactivate debug mode
		move.l	#Map_obj60,($FFFFD004).w
		move.w	#$780,($FFFFD002).w
		move.b	d0,($FFFFD01C).w
		move.w	d0,$A(a0)
		move.w	d0,$E(a0)
		move.w	($FFFFFEF0).w,UpperBound.w ; restore level boundaries
		move.w	($FFFFFEF2).w,TgtLowerBound.w
		cmpi.b	#$10,GameMode.w ; are you in	the special stage?
		bne.s	Debug_DoNothing	; if not, branch
		clr.w	SSAngle.w
		move.w	#$40,SSRotSpeed.w ; set new level rotation speed
		move.l	#Map_obj60,($FFFFD004).w
		move.w	#$780,($FFFFD002).w
		move.b	#2,($FFFFD01C).w
		bset	#2,($FFFFD022).w
...
Nem_SegaLogo:	incbin	artunc\segalogo.comp	; large Sega logo
		even
Eni_SegaLogo:	incbin	mapeni\segalogo.comp	; large Sega logo (mappings)
		even
Eni_Title:	incbin	mapeni\titlescr.bin	; title screen foreground (mappings)
		even
Nem_TitleFg:	incbin	artunc\titlefor.comp	; title screen foreground
		even
Nem_TitleSonic:	incbin	artunc\titleson.comp 	; Sonic on title screen
		even
Nem_TitleTM:	incbin	artunc\titletm.comp 	; TM on title screen
		even
...
; ---------------------------------------------------------------------------
Map_SSWalls:	include "_maps\SSwalls.asm"
; ---------------------------------------------------------------------------
...
; Compressed graphics - various
; ---------------------------------------------------------------------------
Nem_TitleCard:	incbin	artunc\ttlcards.unc	; title cards
		even
...
; ---------------------------------------------------------------------------
Blk16_GHZ:	incbin	map16\ghz.comp
		even
Nem_GHZ_1st:	incbin	artunc\8x8ghz1.comp	; GHZ primary patterns
		even
Nem_GHZ_2nd:	incbin	artunc\8x8ghz2.comp	; GHZ secondary patterns
		even
Blk256_GHZ:	incbin	map256\ghz.comp
		even
Blk16_LZ:	incbin	map16\lz.comp
		even
Nem_LZ:		incbin	artunc\8x8lz.comp	; LZ primary patterns
		even
Blk256_LZ:	incbin	map256\lz.comp
		even
Blk16_MZ:	incbin	map16\mz.comp
		even
Nem_MZ:		incbin	artunc\8x8mz.comp	; MZ primary patterns
		even
Blk256_MZ:	incbin	map256\mz.comp
		even
Blk16_SLZ:	incbin	map16\slz.comp
		even
Nem_SLZ:	incbin	artunc\8x8slz.comp	; SLZ primary patterns
		even
Blk256_SLZ:	incbin	map256\slz.comp
		even
Blk16_SYZ:	incbin	map16\syz.comp
		even
Nem_SYZ:	incbin	artunc\8x8syz.comp	; SYZ primary patterns
		even
Blk256_SYZ:	incbin	map256\syz.comp
		even
Blk16_SBZ:	incbin	map16\sbz.comp
		even
Nem_SBZ:	incbin	artunc\8x8sbz.comp	; SBZ primary patterns
		even
Blk256_SBZ:	incbin	map256\sbz.comp
		even
; ---------------------------------------------------------------------------
