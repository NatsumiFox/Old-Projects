music85_Header:
	...
	smpsHeaderFM	music85_FM1, $F4, $11
	smpsHeaderFM	music85_FM2, $E8, $0B
	smpsHeaderFM	music85_FM3, $F4, $14
	smpsHeaderFM	music85_FM4, $F4, $18
	smpsHeaderFM	music85_FM5, $F4, $18
	smpsHeaderPSG	music85_PSG1, $D0, $06, $00, VolEnv_06
	smpsHeaderPSG	music85_PSG2, $E8, $07, $00, VolEnv_00
	smpsHeaderPSG	music85_PSG3, $00, $05, $00, VolEnv_04
...
;	smpsWeirdD1LRR
	...
	smpsModOff
	smpsFMAlterVol	$08
	smpsCall	music85_Call3
	smpsCall	music85_Call4
...
music85_FM4:
	smpsPan	panLeft, $00
	smpsAlterNote	$03
	smpsCall	music85_Call9
	smpsAlterNote	$00

music85_Jump5:
	smpsModSet	$01, $01, $01, $04
	smpsSetvoice	$02
	smpsCall	music85_Call11
	smpsFMAlterVol	$FC
	dc.b nD6, $02
	smpsCall	music85_Call13
	smpsFMAlterVol	$04
	smpsJump	music85_Jump5

music85_Call11:
	smpsCall	music85_Call12
	dc.b nA6, $30
	smpsCall	music85_Call12
...
music85_Loop6:
	dc.b nRst, $04, nA5, $02
	smpsLoop	$00, $08, music85_Loop6
	smpsPSGAlterVol	$FF

music85_Jump7:
	dc.b $02, nRst, nA5
	smpsJump	music85_Jump7
...
music85_Loop3:
	smpsCall	music85_Call1
	smpsLoop	$00, $03, music85_Loop3
	dc.b nRst, $04, dKick, $08, dSnare, $06, dKick, dKick
	dc.b $06, dSnare, dSnare, dSnare, $04, dKick, $02

music85_Loop4:
	smpsCall	music85_Call1
	smpsLoop	$00, $03, music85_Loop4
	dc.b nRst, $0C, dSnare, $0A, dKick, $02, dSnare, $06
	dc.b dSnare, dSnare, $06, $04, dKick, $02
	smpsJump	music85_Jump1
