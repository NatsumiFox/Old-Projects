music84_Header:
	...
	smpsHeaderFM	music84_FM1, $E8, $00
	smpsHeaderFM	music84_FM2, $E8, $06
	smpsHeaderFM	music84_FM3, $DC, $1A
	smpsHeaderFM	music84_FM4, $DC, $1A
	smpsHeaderFM	music84_FM5, $F4, $20
	smpsHeaderPSG	music84_PSG1, $C4, $06, $00, VolEnv_05
	smpsHeaderPSG	music84_PSG2, $C4, $06, $00, VolEnv_05
	smpsHeaderPSG	music84_PSG3, $00, $04, $00, VolEnv_04
...
music84_Jump2:
	smpsCall	music84_Call1
	dc.b nE6, $1E

music84_Loop1:
	dc.b nE7, $06, nC7, $3C, nRst, $1E
	smpsLoop	$00, $03, music84_Loop1
	dc.b nE7, $06, nC7, $18, nG5, $0C, nA5, nG6
	smpsJump	music84_Jump2

music84_Call1:
	smpsCall	music84_Call2
...
music84_Jump6:
	...
	smpsSetvoice	$03
	smpsFMAlterVol	$EC
	smpsCall	music84_Call9
	smpsAlterNote	$14
	dc.b nA5, $01, smpsNoAttack
	smpsAlterNote	$00
	dc.b nA5, $05
	smpsCall	music84_Call11
	dc.b nEb4
	smpsFMAlterVol	$07
	dc.b nEb4
	smpsSetvoice	$03
	...
	smpsModOff
	smpsFMAlterVol	$14
	smpsJump	music84_Jump6

music84_Call9:
	smpsCall	music84_Call10
	dc.b nEb4
	smpsFMAlterVol	$07
	dc.b nEb4
	smpsSetvoice	$03
...
music84_Jump7:
	...
	smpsNoteFill	$03
	smpsPSGAlterVol	$FE
	smpsJump	music84_Jump7

music84_DAC:
	dc.b nRst, $30
music84_Jump1:
	dc.b dKick, $0C
	smpsJump	music84_Jump1
