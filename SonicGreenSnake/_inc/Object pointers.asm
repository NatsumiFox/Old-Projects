...
; Object pointers
; ---------------------------------------------------------------------------
	dc.l Obj01, WaterFall, Obj03, ObjectFall
	dc.l ObjectFall, ObjectFall, Obj_Signs, Obj08
	...
	dc.l obj_Titlestars, SpinDash_dust, Tails_Tail	; 8F
	dc.l Elemental_Shields, Obj_Dummy, SSF_Players	; 92