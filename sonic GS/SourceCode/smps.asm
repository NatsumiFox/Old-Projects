;
;  Z80 V3.4.1 Z80 Disassembly of z80nodata.bin
;  2007/09/18 15:48
;
...
DAC3A_Location	equ	00B56Ch				;B9
DAC3B_Location	equ	00B9A1h				;sample D3
DAC3C_Location	equ	00C196h				;sample D4
DAC3D_Location	equ	00C361h				;Sample D5
DAC3E_Location	equ	00C860h				;Sample D6
DAC3F_Location	equ	00D084h				;Sample D7 (SOR Snare)
DACD8_Location	equ	00906Eh				;Sample D8
DACD9_Location	equ	009534h				;Sample D8
...
DAC39_Size	equ	0304h
DAC3A_Size	equ	0435h
DAC3B_Size	equ	0410h ;07F5h - Sor Kick
DAC3C_Size	equ	01CBh
DAC3D_Size	equ	04FDh
DAC3E_Size	equ	081Fh ;Sample D6
DAC3F_Size	equ	05ECh ;Sor Snare
DACD8_Size	equ	04E4h
DACD9_Size	equ	1129h
;
Z80Driver_Start:	
...
PCM_Table:
	...
	dw	DAC2_Location	;  Sonic 3 Snare sample
	dw	DAC2_Size
	dw	0005h		; Pitch = 17h
	db	14h
	db      00h
	...
	dw	DAC39_Location			; Sample D1 - Starfox Kick
	dw	DAC39_Size
	dw	0008h
	db	13h
	db        00h
					
	dw	DAC3A_Location			; Sample D2 - Starfox Snare
	dw	DAC3A_Size
	dw	000Dh
	db	13h
	db        00h
						
	dw	DAC3B_Location			; Sample D3 - Streets Of Rage Kick (Sample 81)
	dw	DAC3B_Size
	dw	0008h
	db	13h
	db        00h
	...
	dw	DAC3C_Location			; Sample D4 - Sonic 3 Power Snare (Sample 87)
	dw	DAC3C_Size
	dw	00012h
	db	13h
	db        00h
						
	dw	DAC3D_Location			; Sample D5 - Sonic 3 Power Snare (Sample 87)
	dw	DAC3D_Size
	dw	0000Ah
	db	13h
	db        00h
							
	dw	DAC3E_Location			; Sample D6 - Sonic 3 Power Snare (44Mhz)
	dw	DAC3E_Size
	dw	00001h
	db	13h
	db        00h
								
	dw	DAC3F_Location			; Sample D7 - Streets Of Rage Snare (Sample 82)
	dw	DAC3F_Size
	dw	00008h
	db	13h
	db        00h

	dw	DACD8_Location			; Sample D8 - Bumper Sound
	dw	DACD8_Size
	dw	0016h
	db	14h
	db        01h
	
	dw	DACD9_Location			; Sample D8 - Bumper Sound
	dw	DACD9_Size
	dw	000Eh
	db	14h
	db        01h	
