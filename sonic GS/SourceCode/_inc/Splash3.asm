...
Splash_ClrObjRam3:
            move.l    d0,(a1)+
            dbf    d1,Splash_ClrObjRam3
                
Splash_Art3:        
            move.l    #$40000000,($C00004).l        ; VRAM $0000
            lea    (Art_Splash3).l,a0        ; Image's tiles
...
Splash_Loop3:        
	     ...
	     beq.s	Splash_next3
            ...
            beq.s    Splash_Loop3            ; if not, loop
;            jmp    Splash_Loop3
Splash_Next3:
            move.b    #$4,($FFFFF600).w ; go to next screen
            rts
            
Pal_Splash3:      incbin  'Pallet\splash3.bin'
         even
Art_Splash3:      incbin  'Artnem\splash3.bin'
         even
Map_Splash3:      incbin   'mapeni\splash3.bin'
         even