;===============================================================================
; Menu In Sonic 1 Sonic 2 reprogrammed by Esrael L. G. grandson
; [Home]
;
; The code for this menu is designed to work with
; The disassembly of Sonic 1 made ??by -> drx (www.hacking-cult.org)
;
; If you are using a different disassembly modify the jumps at the end of
; Code to point to routines equivalent.
;
; To use this menu you can just make the following changes to the code
; Original:
...
; Btst # 6 ($ FFFFF604). W
; Beq.w PlayLevel
; Jmp Level_Select_Menu; <- Press the Menu of Sonic 2
; Moveq # 2, d0
; Bsr.w PalLoad
; ...............
;
...
Offset_0x026ADA:
                ...
                jsr     Menu_NemesisDec
;-------------------------------------------------------------------------------                
; Loads of the Fund Mapping Sonic / Miles            
;-------------------------------------------------------------------------------
                lea     ($FFFF0000), A1
...
;-------------------------------------------------------------------------------                
                moveq   #$0E, D1
                lea     $FFFFFBA0(A2), A2
Menu_Clear_Act_x:                                               ; Clean the numbers of Act No. loaded and used the "*" for Sound Test
                move.w  #$0000, (A2)                            ; Load " "
                lea     $0050(A2), A2
...
;                move.w  #$001A, (A2)          ; Load "*"
;-------------------------------------------------------------------------------
; Load the mapping of where St. Kites displayed icons
;------------------------------------------------------------------------------- 
...
;-------------------------------------------------------------------------------                
; Loads the mapping of the icons             
;-------------------------------------------------------------------------------                                    
                lea     ($FFFF08C0), A1
...
;-------------------------------------------------------------------------------                
                ...
                clr.w   ($FFFFF7F0).w
;------------------------------------------------------------------------------- 
                move.w  #$0000, ($FFFFF7B8).w  ; Initialize the frames of animation menu
                move.w  #$0000, ($FFFFF7B9).w  ; Initialize the frames of animation menu
                jsr     Dynamic_Menu           ; Calls the routine animation
;-------------------------------------------------------------------------------
...
Offset_0x026DFC:
                ...
                moveq   #$15, D0     ; Last item after tightening up
Offset_0x026E1C:
                btst    #$01, D1
                beq.s   Offset_0x026E2C
                addq.w  #$01, D0
                cmpi.w  #$0016, D0   ; Checks to see what is the last item in the list
...
Offset_0x026F28:                
                ...
                move.w  D0, (A6)
Offset_0x026F6C:
                cmpi.w  #$0015, ($FFFFFF82).w  ; If equal number selects the Sound Test
                bne.s   Offset_0x026F78
                bsr     Offset_0x026F7A
Offset_0x026F78:
                rts
Offset_0x026F7A:
                move.l  #$49C60003, ($00C00004) ; Position numbers of the Sound Test
                move.w  ($FFFFFF84).w, D0
                move.b  D0, D2
                lsr.b   #$04, D0
...
;-------------------------------------------------------------------------------                            
Dynamic_Menu:                           
                subq.b  #$01, ($FFFFF7B9).w          ; decreases in a Time
                bpl.s   Exit_Dinamic_Menu            ; If greater than or equal to 0 exits the function
                move.b  #$07, ($FFFFF7B9).w          ; Initializes the duration of each frame
...
Menu_Level_Select_Text: 
                dc.b    $0E, _F, _U, _D, _G, _E, __, _H, _I, _L, _L, __, __, __, __, __
                dc.b    $0E, _S, _P, _R, _I, _N, _G, __, _P, _L, _A, _Z, _A, __, __, __
                dc.b    $0E, _H, _O, _T, __, _S, _U, _M, _M, _E, _R, __, __, __, __, __
                dc.b    $0E, _F, _I, _N, _A, _L, __, _B, _A, _T, _T, _L, _E, __, __, __
                dc.b    $0E, _F, _A, _L, _L, __, __, __, __, __, __, __, __, __, __, __
                dc.b    $0E, _M, _E, _T, _A, _L, _L, _I, _C, __, _B, _L, _O, _C, _K, __
                dc.b    $0E, _M, _E, _T, _A, _L, _L, _I, _C, __, _F, _I, _N, _A, _L, __   
                dc.b    $0E, _S, _P, _E, _C, _I, _A, _L, __, _S, _T, _A, _G, _E, __, __
                dc.b    $0E, _E, _N, _D, _I, _N, _G, __, _S, _E, _Q, _U, _E, _N, _C, _E
                dc.b    $0E, _S, _O, _U, _N, _D, _S, __, __, __, __, __, __, _st,__, __  
;-------------------------------------------------------------------------------
Wings_Mappings: 
