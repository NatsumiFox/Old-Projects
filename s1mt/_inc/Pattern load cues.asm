...
; ---------------------------------------------------------------------------
	...
	dc.w SonicLifePLC-ArtLoadCues, PLC_Boss2-ArtLoadCues, TailsLifePLC-ArtLoadCues, PLC_Main-ArtLoadCues, KnuxLifePLC-ArtLoadCues
	dc.w PLC_Explode-ArtLoadCues, PLC_Main-ArtLoadCues
	; Main PLC, Secondary PLC, Animals, free space ; $13
	dc.w PLC_GHZ-ArtLoadCues, PLC_GHZ2-ArtLoadCues, PLC_GHZAnimals-ArtLoadCues, PLC_GHZend-ArtLoadCues
	...
	dc.w PLC_SYZ-ArtLoadCues, PLC_SYZ2-ArtLoadCues, PLC_SYZAnimals-ArtLoadCues, PLC_SYZ2_Boss-ArtLoadCues
	...
	dc.w PLC_Ow-ArtLoadCues, PLC_Ow2-ArtLoadCues, PLC_SBZAnimals-ArtLoadCues, PLC_FZBossPatterns-ArtLoadCues
; ---------------------------------------------------------------------------
...
PLC_Ow2:	dc.w $C
		...
		dc.l Nem_VSpring	; vertical spring
		dc.w $A660
PLC_OWActMain:	dc.w 0
		dc.l Nem_BigFlash	; giant	ring flash effect
		dc.w $8C40

PLC_FZBossPatterns:dc.w 4
		dc.l Nem_Eggmate	;
		dc.w $D000
		dc.l Nem_EggLogo	;
		dc.w $D400
		...
		dc.w $A540
		dc.l Nem_PortalTurret	; portal turrets
		dc.w $D560
		dc.l Nem_Explode	; explosion
		dc.w $B400
; ---------------------------------------------------------------------------
