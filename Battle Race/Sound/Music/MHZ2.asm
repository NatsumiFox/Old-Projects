MHZ2_Header:
	sHeaderInit	; Z80 offset is $9106
	sHeaderPatch	MHZ2_Patches
	sHeaderCh	$06, $03
	sHeaderTempo	$01, $30
	sHeaderDAC	MHZ2_DAC
	sHeaderFM	MHZ2_FM1, $00, $0D
	sHeaderFM	MHZ2_FM2, $00, $0F
	sHeaderFM	MHZ2_FM3, $00, $0A
	sHeaderFM	MHZ2_FM4, $00, $0A
	sHeaderFM	MHZ2_FM5, $00, $13
	sHeaderPSG	MHZ2_PSG1, $E8, $02, $00, VolEnv_00
	sHeaderPSG	MHZ2_PSG2, $E8, $02, $00, VolEnv_00
	sHeaderPSG	MHZ2_PSG3, $E8, $02, $00, VolEnv_00
...
MHZ2_DAC:
	dc.b dKick, $0C, dSnare, dKick, dSnare, dKick, $04, dKick
	dc.b dKick, dSnare, $0C, dSnare, dSnare, $06, dSnare
MHZ2_Jump6:
