GameOver_Header:
	sHeaderInit	; Z80 offset is $DD4B
	...
	sHeaderPSG	GameOver_PSG1, $F4, $03, $05, VolEnv_00
	sHeaderPSG	GameOver_PSG2, $E8, $03, $05, VolEnv_00
	sHeaderPSG	GameOver_PSG3, $00, $00, $00, VolEnv_03
