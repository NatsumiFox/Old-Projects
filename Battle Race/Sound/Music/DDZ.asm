DDZ_Header:
	sHeaderInit	; Z80 offset is $D3DD
	sHeaderPatch	DDZ_Patches
	sHeaderCh	$06, $03
	sHeaderTempo	$01, $0A
	sHeaderDAC	DDZ_DAC
	sHeaderFM	DDZ_FM1, $00, $0E
	sHeaderFM	DDZ_FM2, $00, $0A
	sHeaderFM	DDZ_FM3, $00, $04
	sHeaderFM	DDZ_FM4, $00, $04
	sHeaderFM	DDZ_FM5, $00, $15
	sHeaderPSG	DDZ_PSG1, $E8, $04, $00, VolEnv_00
	sHeaderPSG	DDZ_PSG2, $E8, $04, $00, VolEnv_00
	sHeaderPSG	DDZ_PSG3, $E8, $02, $00, VolEnv_00
...
DDZ_Loop2:
	dc.b nRst, $60
	sLoop		$00, $04, DDZ_Loop2

DDZ_Loop3:
	dc.b nD6, $06, nD7, nD6
	sLoop		$00, $0F, DDZ_Loop3
	dc.b nD6, $06

DDZ_Loop4:
	dc.b nCs7, $06, nCs6, nCs6
	sLoop		$00, $06, DDZ_Loop4

DDZ_Loop5:
DDZ_Jump2:
	dc.b nRst, $60
	sLoop		$00, $18, DDZ_Loop5
