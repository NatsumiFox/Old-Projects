Pachinko_Header:
	sHeaderInit	; Z80 offset is $DCC0
	sHeaderPatch	Pachinko_Patches
	sHeaderCh	$06, $03
	sHeaderTempo	$01, $16
	sHeaderDAC	Pachinko_DAC
	sHeaderFM	Pachinko_FM1, $00, $0B
	sHeaderFM	Pachinko_FM2, $00, $07
	sHeaderFM	Pachinko_FM3, $00, $0B
	sHeaderFM	Pachinko_FM4, $00, $0B
	sHeaderFM	Pachinko_FM5, $00, $14
	sHeaderPSG	Pachinko_PSG1, $E8, $06, $00, VolEnv_00
	sHeaderPSG	Pachinko_PSG2, $E8, $02, $00, VolEnv_00
	sHeaderPSG	Pachinko_PSG3, $E8, $02, $00, VolEnv_00
...
Pachinko_Jump1:
	dc.b nRst, $60
	ssModZ80	$0D, $03, $02, $0A
	sLoop		$00, $0A, Pachinko_Loop1
...
Pachinko_Loop2:
	dc.b nRst, $60
	sLoop		$00, $0A, Pachinko_Loop2
	sJump		Pachinko_Jump1
	; Unused
	dc.b $F2
