FinalBoss_Header:
	sHeaderInit	; Z80 offset is $F74C
	sHeaderPatch	FinalBoss_Patches
	sHeaderCh	$06, $03
	sHeaderTempo	$01, $57
	sHeaderDAC	FinalBoss_DAC
	sHeaderFM	FinalBoss_FM1, $00, $0E
	sHeaderFM	FinalBoss_FM2, $00, $0C
	sHeaderFM	FinalBoss_FM3, $00, $0E
	sHeaderFM	FinalBoss_FM4, $00, $0E
	sHeaderFM	FinalBoss_FM5, $00, $12
	sHeaderPSG	FinalBoss_PSG1, $E8, $02, $00, VolEnv_00
	sHeaderPSG	FinalBoss_PSG2, $E8, $03, $00, VolEnv_00
	sHeaderPSG	FinalBoss_PSG3, $E8, $02, $00, VolEnv_00
...
FinalBoss_Loop23:
	dc.b nRst, $30, nRst, $18
	sLoop		$00, $04, FinalBoss_Loop23

FinalBoss_Loop24:
	dc.b dKick, $24, dSnare, $1B, dKick, $09
	sLoop		$00, $03, FinalBoss_Loop24
...
FinalBoss_Loop27:
	...
	dc.b dKick, dSnare, $06, dKick, $0C, dKick, $06, dSnare
	dc.b $0C
	sLoop		$00, $04, FinalBoss_Loop27
	dc.b dKick, $06, dKick, dSnare, $24, nRst, dSnare, $0C
	sJump		FinalBoss_Jump8
	; Unused
	dc.b $F2
