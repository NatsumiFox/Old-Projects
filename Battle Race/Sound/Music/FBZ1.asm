FBZ1_Header:
	...
	sHeaderTempo	$01, $00
	sHeaderDAC	FBZ1_DAC
	sHeaderFM	FBZ1_FM1, $00, $0A
	sHeaderFM	FBZ1_FM2, $00, $0A
	sHeaderFM	FBZ1_FM3, $00, $0D
	sHeaderFM	FBZ1_FM4, $00, $0D
	sHeaderFM	FBZ1_FM5, $00, $13
	sHeaderPSG	FBZ1_PSG1, $E8, $02, $00, VolEnv_00
	sHeaderPSG	FBZ1_PSG2, $E8, $02, $00, VolEnv_00
	sHeaderPSG	FBZ1_PSG3, $E8, $02, $00, VolEnv_00
...
FBZ1_Patches:
	...
	; Patch $05
	; $38
	; $73, $55, $12, $31,	$16, $15, $14, $12
	; $0E, $01, $05, $04,	$0C, $13, $0C, $0B
	; $FF, $EF, $DF, $8F,	$36, $38, $21, $85
	spAlgorithm	$00
	spFeedback	$07
	spDetune	$07, $01, $05, $03
	spMultiple	$03, $02, $05, $01
	spRateScale	$00, $00, $00, $00
