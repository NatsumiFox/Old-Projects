SOZ1_Header:
	sHeaderInit	; Z80 offset is $9688
	sHeaderPatch	SOZ1_Patches
	sHeaderCh	$06, $03
	sHeaderTempo	$01, $12
	sHeaderDAC	SOZ1_DAC
	sHeaderFM	SOZ1_FM1, $00, $0B
	sHeaderFM	SOZ1_FM2, $00, $0A
	sHeaderFM	SOZ1_FM3, $00, $0C
	sHeaderFM	SOZ1_FM4, $00, $0C
	sHeaderFM	SOZ1_FM5, $00, $14
	sHeaderPSG	SOZ1_PSG1, $E8, $04, $00, VolEnv_00
	sHeaderPSG	SOZ1_PSG2, $E8, $02, $00, VolEnv_00
	sHeaderPSG	SOZ1_PSG3, $E8, $02, $00, VolEnv_00
...
SOZ1_Jump5:
	...
	dc.b nC2, $06, nRst
	sLoop		$00, $04, SOZ1_Loop2

SOZ1_Loop3:
	dc.b nE1, $0C, nRst, $24, nE1, $0C, nE1, $0A
	dc.b nRst, $1A
	sLoop		$00, $07, SOZ1_Loop3
	dc.b nE1, $0C, nRst, $24, nE1, $0C, nE1, $0A
	dc.b nRst, $0E, nB1, $0C
