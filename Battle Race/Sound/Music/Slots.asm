Slots_Header:
	sHeaderInit	; Z80 offset is $EABB
	sHeaderPatch	Slots_Patches
	sHeaderCh	$06, $03
	sHeaderTempo	$01, $20
	sHeaderDAC	Slots_DAC
	sHeaderFM	Slots_FM1, $F4, $09
	sHeaderFM	Slots_FM2, $F4, $0E
	sHeaderFM	Slots_FM3, $00, $0B
	sHeaderFM	Slots_FM4, $00, $1D
	sHeaderFM	Slots_FM5, $00, $08
	sHeaderPSG	Slots_PSG1, $E8, $04, $05, VolEnv_00
	sHeaderPSG	Slots_PSG2, $E8, $04, $05, VolEnv_00
	sHeaderPSG	Slots_PSG3, $00, $00, $00, VolEnv_03
