Miniboss_Header:
	sHeaderInit	; Z80 offset is $CBB1
	sHeaderPatch	Miniboss_Patches
	sHeaderCh	$06, $03
	sHeaderTempo	$01, $00
	sHeaderDAC	Miniboss_DAC
	sHeaderFM	Miniboss_FM1, $00, $0C
	sHeaderFM	Miniboss_FM2, $00, $0C
	sHeaderFM	Miniboss_FM3, $00, $0C
	sHeaderFM	Miniboss_FM4, $00, $0C
	sHeaderFM	Miniboss_FM5, $00, $0E
	sHeaderPSG	Miniboss_PSG1, $E8, $02, $00, VolEnv_00
	sHeaderPSG	Miniboss_PSG2, $E8, $02, $00, VolEnv_00
	sHeaderPSG	Miniboss_PSG3, $E8, $02, $00, VolEnv_00
...
Miniboss_Jump2:
	...
	sLoop		$00, $04, Miniboss_Loop2

Miniboss_Loop3:
	dc.b nA4, $06, nC5, nF5, nC5
	sLoop		$00, $04, Miniboss_Loop3
