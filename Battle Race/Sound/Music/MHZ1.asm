MHZ1_Header:
	sHeaderInit	; Z80 offset is $8AFE
	sHeaderPatch	MHZ1_Patches
	sHeaderCh	$06, $03
	sHeaderTempo	$01, $39
	sHeaderDAC	MHZ1_DAC
	sHeaderFM	MHZ1_FM1, $00, $0D
	sHeaderFM	MHZ1_FM2, $00, $0F
	sHeaderFM	MHZ1_FM3, $00, $0A
	sHeaderFM	MHZ1_FM4, $00, $0A
	sHeaderFM	MHZ1_FM5, $00, $16
	sHeaderPSG	MHZ1_PSG1, $E8, $02, $00, VolEnv_00
	sHeaderPSG	MHZ1_PSG2, $E8, $02, $00, VolEnv_00
	sHeaderPSG	MHZ1_PSG3, $E8, $02, $00, VolEnv_00
...
MHZ1_FM2:
	...
	dc.b nD3, $0C, nD3, $0C, nRst, $14, nD3, $03
	dc.b nRst, $01, nC3, $08, nB2, $04, nA2, $0C
...
MHZ1_FM3:
	...
	ssModZ80	$0D, $01, $02, $06
	sPan		spLeft, $00
	dc.b nRst, $06, nFs4, $02, nG4, nAb4, nA4, $0A
	dc.b nRst, $02, nA4, $0A, nRst, $02, nRst, $06
	dc.b nFs4, $02, nG4, nAb4, nA4, $0A, nRst, $02
	dc.b nA4, $0A, nRst, $02, nRst, $0C, nA4, $0A
...
MHZ1_FM4:
	...
	ssModZ80	$0D, $01, $02, $06
	sPan		spRight, $00
	dc.b nRst, $06, nEb4, $02, nE4, nF4, nFs4, $0A
	dc.b nRst, $02, nFs4, $0A, nRst, $02, nRst, $06
	dc.b nEb4, $02, nE4, nF4, nFs4, $0A, nRst, $02
	dc.b nFs4, $0A, nRst, $02, nRst, $0C, nFs4, $0A
	dc.b nRst, $02, nRst, $30
...
MHZ1_DAC:
	...
	dc.b dSnare, dKick, $08, dKick, $04, dSnare, $18, dKick
	dc.b $04, dKick, dKick
MHZ1_Jump6:
