DEZ1_Header:
	sHeaderInit	; Z80 offset is $C2B4
	...
	sHeaderPSG	DEZ1_PSG1, $E8, $02, $00, VolEnv_00
	sHeaderPSG	DEZ1_PSG2, $E8, $02, $00, VolEnv_00
	sHeaderPSG	DEZ1_PSG3, $E8, $02, $00, VolEnv_00
...
DEZ1_Loop11:
	...
	sLoop		$00, $02, DEZ1_Loop11

DEZ1_Loop12:
	dc.b nRst, $60
	sLoop		$00, $08, DEZ1_Loop12
	sJump		DEZ1_Jump3
...
DEZ1_Loop7:
	...
	sLoop		$00, $04, DEZ1_Loop7

DEZ1_Loop8:
	dc.b nBb2, $06, nC3, nD3, nF3
	sLoop		$00, $04, DEZ1_Loop8
...
DEZ1_Loop9:
	dc.b nAb2, $06, nBb2, nC3, nEb3
	sLoop		$00, $04, DEZ1_Loop9

DEZ1_Loop10:
	dc.b nBb2, $06, nC3, nD3, nF3
	sLoop		$00, $04, DEZ1_Loop10
	dc.b nRst, $60, nRst, $06, nG4, $12, nF4, $06
...
DEZ1_Patches:
	...
	spTotalLv	$82, $08, $08, $08	; INCORRECT TL VALUE!!!
