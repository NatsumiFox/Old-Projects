MGZ2_Header:
	sHeaderInit	; Z80 offset is $D97B
	sHeaderPatch	MGZ2_Patches
	sHeaderCh	$06, $03
	sHeaderTempo	$01, $3D
	sHeaderDAC	MGZ2_DAC
	sHeaderFM	MGZ2_FM1, $00, $09
	sHeaderFM	MGZ2_FM2, $00, $0C
	sHeaderFM	MGZ2_FM3, $00, $0D
	sHeaderFM	MGZ2_FM4, $00, $0D
	sHeaderFM	MGZ2_FM5, $00, $1D
	sHeaderPSG	MGZ2_PSG1, $E8, $02, $00, VolEnv_00
	sHeaderPSG	MGZ2_PSG2, $E8, $02, $00, VolEnv_00
	sHeaderPSG	MGZ2_PSG3, $E8, $02, $00, VolEnv_00
