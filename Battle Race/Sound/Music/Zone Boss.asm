ZoneBoss_Header:
	sHeaderInit	; Z80 offset is $CEE1
	sHeaderPatch	ZoneBoss_Patches
	sHeaderCh	$06, $03
	sHeaderTempo	$01, $00
	sHeaderDAC	ZoneBoss_DAC
	sHeaderFM	ZoneBoss_FM1, $00, $0C
	sHeaderFM	ZoneBoss_FM2, $00, $0C
	sHeaderFM	ZoneBoss_FM3, $00, $0C
	sHeaderFM	ZoneBoss_FM4, $00, $0C
	sHeaderFM	ZoneBoss_FM5, $00, $13
	sHeaderPSG	ZoneBoss_PSG1, $E8, $03, $00, VolEnv_00
	sHeaderPSG	ZoneBoss_PSG2, $E8, $02, $00, VolEnv_00
	sHeaderPSG	ZoneBoss_PSG3, $E8, $02, $00, VolEnv_00
...
ZoneBoss_Loop5:
	...
	dc.b $18, nB3, nG3, nE3
	sLoop		$00, $02, ZoneBoss_Loop5
	sJump		ZoneBoss_Jump4
	; Unused
	dc.b $F2
...
ZoneBoss_Loop3:
	...
	dc.b $18, nG3, nE3, nB2
	sLoop		$00, $02, ZoneBoss_Loop3
	sJump		ZoneBoss_Jump3
	; Unused
	dc.b $F2
...
ZoneBoss_Loop9:
	...
	sLoop		$00, $0F, ZoneBoss_Loop9
	dc.b dKick, $0C, dSnare, dSnare, dSnare, $06, dSnare, dKick
	dc.b $0C, dSnare, dSnare, dSnare
	sJump		ZoneBoss_Jump7
	; Unused
	dc.b $F2
