MGZ1_Header:
	sHeaderInit	; Z80 offset is $D364
	sHeaderPatch	MGZ1_Patches
	sHeaderCh	$06, $03
	sHeaderTempo	$01, $40
	sHeaderDAC	MGZ1_DAC
	sHeaderFM	MGZ1_FM1, $00, $0C
	sHeaderFM	MGZ1_FM2, $00, $0D
	sHeaderFM	MGZ1_FM3, $00, $0D
	sHeaderFM	MGZ1_FM4, $00, $0D
	sHeaderFM	MGZ1_FM5, $00, $12
	sHeaderPSG	MGZ1_PSG1, $E8, $02, $00, VolEnv_00
	sHeaderPSG	MGZ1_PSG2, $E8, $02, $00, VolEnv_00
	sHeaderPSG	MGZ1_PSG3, $E8, $02, $00, VolEnv_00
