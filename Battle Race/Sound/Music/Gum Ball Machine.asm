GumBallMachine_Header:
	sHeaderInit	; Z80 offset is $8AE8
	sHeaderPatch	GumBallMachine_Patches
	sHeaderCh	$06, $03
	sHeaderTempo	$01, $1E
	sHeaderDAC	GumBallMachine_DAC
	sHeaderFM	GumBallMachine_FM1, $F4, $1A
	sHeaderFM	GumBallMachine_FM2, $F4, $09
	sHeaderFM	GumBallMachine_FM3, $F4, $1A
	sHeaderFM	GumBallMachine_FM4, $F4, $16
	sHeaderFM	GumBallMachine_FM5, $F4, $19
	sHeaderPSG	GumBallMachine_PSG1, $DC, $03, $00, VolEnv_00
	sHeaderPSG	GumBallMachine_PSG2, $E8, $03, $00, VolEnv_00
	sHeaderPSG	GumBallMachine_PSG3, $00, $00, $00, VolEnv_03
