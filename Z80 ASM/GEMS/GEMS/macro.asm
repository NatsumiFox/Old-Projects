...
gIfeq		macro box, value, ptr
	dc.b 113, \box, 0, \value, \ptr-*	; seqifeq
    endm

gIfne		macro box, value, ptr
	dc.b 113, \box, 1, \value, \ptr-*	; seqifne
    endm

gIfgt		macro box, value, ptr
	dc.b 113, \box, 2, \value, \ptr-*	; seqifgt
    endm

gIfge		macro box, value, ptr
	dc.b 113, \box, 3, \value, \ptr-*	; seqifgte
    endm

gIflt		macro box, value, ptr
	dc.b 113, \box, 4, \value, \ptr-*	; seqiflt
    endm

gIfle		macro box, value, ptr
	dc.b 113, \box, 5, \value, \ptr-*	; seqiflte
    endm
