...
CS5_SetupVDP:	lea	($C00004).l,a6			; Setup teh VDP
...
CS5_ClrObjRam:
			move.l	d0,(a1)+
			dbf	d1,CS5_ClrObjRam
				
CS5_Art:		move.l	#$40000000,($C00004).l		; VRAM $0000
			lea	(Art_CS5).l,a0		; Image's tiles
...
CS5_ShowOnVDP:	lea	($FF0000).l,a1			; Show screen
...
CS5_Music:		move.w	#$91,d0		; Play music
			jsr	PlaySound
...
;Set the object's ID on $FFFFD000
			...
			jsr	BuildSprites
; ---------------------------------------------------------------------------------------------------------------------
CS5_Loop:		move.b	#2,($FFFFF62A).w		; Function 2 in vInt
			jsr	DelayProgram			; Run delay program
			jsr	ObjectsLoad
			jsr	BuildSprites
			andi.b	#$80,($FFFFF605).w		; is Start button pressed?
			beq.s	CS5_Loop			; if not, loop
;			jmp	CS5_Loop
CS5_Next:
			move.b	#$24,($FFFFF600).w ; go to next screen
			rts

Pal_CS5:		incbin	'CS5/pal.bin'
			even
Art_CS5:		incbin	'CS5/tiles.bin'
			even
Map_CS5:		incbin	'CS5/maps.bin'
			even