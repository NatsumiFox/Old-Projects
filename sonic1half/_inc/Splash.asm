...
Splash_Music:        move.w    #$91,d0        ; Play music
            jsr    PlaySound
...
Splash_Next:
            ...
            rts
; ---------------------------------------------------------------------------------------------------------------------
Pal_Splash:             incbin  'pallet\PALETTEFILE.BIN'
                        even
Art_Splash:             incbin  'artnem\TILESFILE.BIN'
                        even
Map_Splash:             incbin  'mapeni\mapsfiles.BIN'
                        even