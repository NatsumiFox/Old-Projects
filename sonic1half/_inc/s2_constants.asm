;-------------------------------------------------------------------------------
; some constants and variables of this code and other 
; constants of sonic 2 used in this code (s2_beginning.asm, 
; s2_results.asm, s2_menu.asm, s2_option.asm, s2_end.asm 
; and imported objects of Sonic 2)
;-------------------------------------------------------------------------------
