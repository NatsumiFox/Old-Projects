...
CS2_SetupVDP:	lea	($C00004).l,a6			; Setup teh VDP
...
CS2_ClrObjRam:
			move.l	d0,(a1)+
			dbf	d1,CS2_ClrObjRam
				
CS2_Art:		move.l	#$40000000,($C00004).l		; VRAM $0000
			lea	(Art_CS2).l,a0		; Image's tiles
...
CS2_ShowOnVDP:	lea	($FF0000).l,a1			; Show screen
...
CS2_Music:		move.w	#$E4,d0		; Play music
			jsr	PlaySound
...
;Set the object's ID on $FFFFD000
			...
			jsr	BuildSprites
; ---------------------------------------------------------------------------------------------------------------------
CS2_Loop:		move.b	#2,($FFFFF62A).w		; Function 2 in vInt
			jsr	DelayProgram			; Run delay program
			jsr	ObjectsLoad
			jsr	BuildSprites
			andi.b	#$80,($FFFFF605).w		; is Start button pressed?
			beq.s	CS2_Loop			; if not, loop
;			jmp	CS2_Loop
CS2_Next:
			move.b	#$28,($FFFFF600).w ; go to next screen
			rts

Pal_CS2:		incbin	'CS2/pal.bin'
			even
Art_CS2:		incbin	'CS2/tiles.bin'
			even
Map_CS2:		incbin	'CS2/maps.bin'
			even