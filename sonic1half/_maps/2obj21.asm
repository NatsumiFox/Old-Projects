...
; ---------------------------------------------------------------------------
      dc.w bytea_1C5BC-Map_obj21, bytea_1C5F0-Map_obj21
      dc.w bytea_1C624-Map_obj21, bytea_1C658-Map_obj21
      
      ; Y-Pos, layout, VDP (2byteas - plane, pallet line (2bits), flip, mirror, first tile (11bits) - ), X-Pos
bytea_1C5BC:   dc.b $C
